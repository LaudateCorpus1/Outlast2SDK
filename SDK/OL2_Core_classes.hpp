...
public:
	...
	struct FPointer                                    HashPrev;                                                 // 0x0008(0x0008) (Const, Native, EditConst)
	struct FPointer                                    HashNext;                                                 // 0x0010(0x0008) (Const, Native, EditConst)
	struct FQWord                                      ObjectFlags;                                              // 0x0018(0x0008) (Const, Native, EditConst)
	struct FPointer                                    HashOuterNext;                                            // 0x0020(0x0008) (Const, Native, EditConst)
	struct FPointer                                    StateFrame;                                               // 0x0028(0x0008) (Const, Native, EditConst)
	class UObject*                                     Linker;                                                   // 0x0030(0x0008) (Const, Native, EditConst, NoExport)
	struct FPointer                                    LinkerIndex;                                              // 0x0038(0x0008) (Const, Native, EditConst, NoExport)
	int                                                ObjectInternalInteger;                                    // 0x0040(0x0004) (Const, Native, EditConst, NoExport)
	int                                                NetIndex;                                                 // 0x0044(0x0004) (Const, Native, EditConst, NoExport)
	class UObject*                                     Outer;                                                    // 0x0048(0x0008) (Const, Native, EditConst)
	struct FName                                       Name;                                                     // 0x0050(0x0008) (Edit, Const, Native, EditConst)
	class UClass*                                      Class;                                                    // 0x0058(0x0008) (Const, Native, EditConst)
	class UObject*                                     ObjectArchetype;                                          // 0x0060(0x0008) (Edit, Const, Native, EditConst)
...
// Class Core.System
// 0x00E4 (0x0154 - 0x0070)
class USystem : public USubsystem
{
public:
	int                                                StaleCacheDays;                                           // 0x0070(0x0004) (Config)
	int                                                MaxStaleCacheSize;                                        // 0x0074(0x0004) (Config)
	int                                                MaxOverallCacheSize;                                      // 0x0078(0x0004) (Config)
	int                                                PackageSizeSoftLimit;                                     // 0x007C(0x0004) (Config)
	float                                              AsyncIOBandwidthLimit;                                    // 0x0080(0x0004) (Config)
	struct FString                                     SavePath;                                                 // 0x0084(0x0010) (Config, NeedCtorLink)
	struct FString                                     CachePath;                                                // 0x0094(0x0010) (Config, NeedCtorLink)
	struct FString                                     CacheExt;                                                 // 0x00A4(0x0010) (Config, NeedCtorLink)
	TArray<struct FString>                             Paths;                                                    // 0x00B4(0x0010) (Config, NeedCtorLink)
...
{
public:
	unsigned char                                      UnknownData00[0x168];                                     // 0x0068(0x0168) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0xB8];                                      // 0x01D0(0x00B8) MISSED OFFSET
...
// 0x0608 (0x07D8 - 0x01D0)
class ULinkerLoad : public ULinker
{
public:
	unsigned char                                      UnknownData00[0x608];                                     // 0x01D0(0x0608) MISSED OFFSET
...
public:
	...
	int16_t                                            iNative;                                                  // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
...
{
public:
	class UClass*                                      SupportedClass;                                           // 0x0068(0x0008)
	class UClass*                                      ContextClass;                                             // 0x0070(0x0008)
	struct FString                                     Description;                                              // 0x0078(0x0010) (NeedCtorLink)
	TArray<struct FString>                             Formats;                                                  // 0x0088(0x0010) (NeedCtorLink)
	unsigned long                                      bCreateNew : 1;                                           // 0x0098(0x0004)
	unsigned long                                      bEditAfterNew : 1;                                        // 0x0098(0x0004)
	unsigned long                                      bEditorImport : 1;                                        // 0x0098(0x0004)
	unsigned long                                      bText : 1;                                                // 0x0098(0x0004)
	int                                                AutoPriority;                                             // 0x009C(0x0004)
	TArray<struct FString>                             ValidGameNames;                                           // 0x00A0(0x0010) (NeedCtorLink)
...
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x0068(0x0008) MISSED OFFSET
	TArray<struct FString>                             FormatExtension;                                          // 0x0070(0x0010) (NeedCtorLink)
	TArray<struct FString>                             FormatDescription;                                        // 0x0080(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData01[0xC];                                       // 0x0090(0x000C) MISSED OFFSET
...
{
public:
	class UClass*                                      TemplateOwnerClass;                                       // 0x0068(0x0008) (Const, Native)
	struct FName                                       TemplateName;                                             // 0x0070(0x0008) (Const, Native)
...
{
public:
	struct FPointer                                    VfTable_FCurveEdInterface;                                // 0x0078(0x0008) (Const, Native, NoExport)
	unsigned long                                      bCanBeBaked : 1;                                          // 0x0080(0x0004) (Edit)
	unsigned long                                      bIsDirty : 1;                                             // 0x0080(0x0004)
...
{
public:
	struct FString                                     HelpDescription;                                          // 0x0068(0x0010) (Const, Localized, NeedCtorLink)
	struct FString                                     HelpUsage;                                                // 0x0078(0x0010) (Const, Localized, NeedCtorLink)
	struct FString                                     HelpWebLink;                                              // 0x0088(0x0010) (Const, Localized, NeedCtorLink)
	TArray<struct FString>                             HelpParamNames;                                           // 0x0098(0x0010) (Const, Localized, NeedCtorLink)
	TArray<struct FString>                             HelpParamDescriptions;                                    // 0x00A8(0x0010) (Const, Localized, NeedCtorLink)
	unsigned long                                      IsServer : 1;                                             // 0x00B8(0x0004)
	unsigned long                                      IsClient : 1;                                             // 0x00B8(0x0004)
	unsigned long                                      IsEditor : 1;                                             // 0x00B8(0x0004)
	unsigned long                                      LogToConsole : 1;                                         // 0x00B8(0x0004)
	unsigned long                                      ShowErrorCount : 1;                                       // 0x00B8(0x0004)
...
{
public:
	unsigned char                                      UnknownData00[0xD8];                                      // 0x0068(0x00D8) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x54];                                      // 0x00D8(0x0054) MISSED OFFSET
