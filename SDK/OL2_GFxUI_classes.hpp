...
{
public:
	TArray<struct FGCReference>                        GCReferences;                                             // 0x0068(0x0010) (Transient, NeedCtorLink)
	int                                                RefCount;                                                 // 0x0078(0x0004) (Transient)
...
{
public:
	struct FPointer                                    VfTable_FCallbackEventDevice;                             // 0x00B8(0x0008) (Const, Native, NoExport)
	unsigned long                                      bFakeMobileTouches : 1;                                   // 0x00C0(0x0004)
...
// 0x0184 (0x01EC - 0x0068)
class UGFxMoviePlayer : public UObject
{
public:
	struct FPointer                                    pMovie;                                                   // 0x0068(0x0008) (Const, Native, Transient)
	struct FPointer                                    pCaptureKeys;                                             // 0x0070(0x0008) (Const, Native, Transient)
	struct FPointer                                    pFocusIgnoreKeys;                                         // 0x0078(0x0008) (Const, Native, Transient)
	unsigned char                                      UnknownData00[0x48];                                      // 0x0080(0x0048) UNKNOWN PROPERTY: MapProperty GFxUI.GFxMoviePlayer.ASUClasses
	unsigned char                                      UnknownData01[0x48];                                      // 0x00C8(0x0048) UNKNOWN PROPERTY: MapProperty GFxUI.GFxMoviePlayer.ASUObjects
	int                                                NextASUObject;                                            // 0x0110(0x0004) (Const, Transient)
	class USwfMovie*                                   MovieInfo;                                                // 0x0114(0x0008)
	unsigned long                                      bMovieIsOpen : 1;                                         // 0x011C(0x0004) (Const)
	unsigned long                                      bDisplayWithHudOff : 1;                                   // 0x011C(0x0004)
	unsigned long                                      bEnableGammaCorrection : 1;                               // 0x011C(0x0004)
	unsigned long                                      bWidgetsInitializedThisFrame : 1;                         // 0x011C(0x0004) (Const, Transient)
	unsigned long                                      bLogUnhandedWidgetInitializations : 1;                    // 0x011C(0x0004)
	unsigned long                                      bAllowInput : 1;                                          // 0x011C(0x0004)
	unsigned long                                      bAllowFocus : 1;                                          // 0x011C(0x0004)
	unsigned long                                      bConvertMovmentInputToUIInput : 1;                        // 0x011C(0x0004)
	unsigned long                                      bAutoPlay : 1;                                            // 0x011C(0x0004)
	unsigned long                                      bPauseGameWhileActive : 1;                                // 0x011C(0x0004)
	unsigned long                                      bDisableWorldRendering : 1;                               // 0x011C(0x0004)
	unsigned long                                      bCaptureWorldRendering : 1;                               // 0x011C(0x0004)
	unsigned long                                      bCloseOnLevelChange : 1;                                  // 0x011C(0x0004)
	unsigned long                                      bOnlyOwnerFocusable : 1;                                  // 0x011C(0x0004)
	unsigned long                                      bForceFullViewport : 1;                                   // 0x011C(0x0004)
	unsigned long                                      bDiscardNonOwnerInput : 1;                                // 0x011C(0x0004)
	unsigned long                                      bCaptureInput : 1;                                        // 0x011C(0x0004)
	unsigned long                                      bCaptureMouseInput : 1;                                   // 0x011C(0x0004)
	unsigned long                                      bIgnoreMouseInput : 1;                                    // 0x011C(0x0004)
	unsigned long                                      bIsSplitscreenLayoutModified : 1;                         // 0x011C(0x0004) (Transient)
	unsigned long                                      bShowHardwareMouseCursor : 1;                             // 0x011C(0x0004)
	unsigned long                                      bBlurLesserMovies : 1;                                    // 0x011C(0x0004)
	unsigned long                                      bHideLesserMovies : 1;                                    // 0x011C(0x0004)
	unsigned long                                      bIsPriorityBlurred : 1;                                   // 0x011C(0x0004)
	unsigned long                                      bIsPriorityHidden : 1;                                    // 0x011C(0x0004)
	unsigned long                                      bIgnoreVisibilityEffect : 1;                              // 0x011C(0x0004)
	unsigned long                                      bIgnoreBlurEffect : 1;                                    // 0x011C(0x0004)
	class UTextureRenderTarget2D*                      RenderTexture;                                            // 0x0120(0x0008) (Edit)
	int                                                LocalPlayerOwnerIndex;                                    // 0x0128(0x0004) (Transient)
	class UObject*                                     ExternalInterface;                                        // 0x012C(0x0008)
	TArray<struct FName>                               CaptureKeys;                                              // 0x0134(0x0010) (NeedCtorLink)
	TArray<struct FName>                               FocusIgnoreKeys;                                          // 0x0144(0x0010) (NeedCtorLink)
	TArray<struct FExternalTexture>                    ExternalTextures;                                         // 0x0154(0x0010) (NeedCtorLink)
	TArray<struct FSoundThemeBinding>                  SoundThemes;                                              // 0x0164(0x0010) (Edit, NeedCtorLink)
	TEnumAsByte<EGFxTimingMode>                        TimingMode;                                               // 0x0174(0x0001)
	TEnumAsByte<EGFxRenderTextureMode>                 RenderTextureMode;                                        // 0x0175(0x0001)
	unsigned char                                      Priority;                                                 // 0x0176(0x0001)
	unsigned char                                      UnknownData02[0x1];                                       // 0x0177(0x0001) MISSED OFFSET
	TArray<struct FGFxWidgetBinding>                   WidgetBindings;                                           // 0x0178(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData03[0x48];                                      // 0x0188(0x0048) UNKNOWN PROPERTY: MapProperty GFxUI.GFxMoviePlayer.WidgetPathBindings
	class UGFxObject*                                  SplitscreenLayoutObject;                                  // 0x01D0(0x0008) (Transient)
	int                                                SplitscreenLayoutYAdjust;                                 // 0x01D8(0x0004) (Config)
...
{
public:
	TArray<unsigned char>                              RawData;                                                  // 0x0068(0x0010) (Const, NeedCtorLink)
	TArray<struct FString>                             ReferencedSwfs;                                           // 0x0078(0x0010) (Edit, EditConst, NeedCtorLink)
	TArray<class UObject*>                             References;                                               // 0x0088(0x0010) (Edit, EditConst, NeedCtorLink)
	TArray<class UObject*>                             UserReferences;                                           // 0x0098(0x0010) (Edit, NeedCtorLink)
...
{
public:
	unsigned long                                      bUsesFontlib : 1;                                         // 0x00A8(0x0004) (Edit)
	unsigned long                                      bSetSRGBOnImportedTextures : 1;                           // 0x00A8(0x0004) (Edit, EditConst)
	unsigned long                                      bPackTextures : 1;                                        // 0x00A8(0x0004) (Edit)
	unsigned long                                      bForceSquarePacking : 1;                                  // 0x00A8(0x0004) (Edit)
	struct FString                                     SourceFile;                                               // 0x00AC(0x0010) (Edit, NeedCtorLink)
	int                                                PackTextureSize;                                          // 0x00BC(0x0004) (Edit)
	TEnumAsByte<EFlashTextureRescale>                  TextureRescale;                                           // 0x00C0(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00C1(0x0003) MISSED OFFSET
	struct FString                                     TextureFormat;                                            // 0x00C4(0x0010) (Edit, EditConst, NeedCtorLink)
	struct FString                                     SourceFileTimestamp;                                      // 0x00D4(0x0010) (Edit, EditConst, NeedCtorLink)
	int                                                RTTextures;                                               // 0x00E4(0x0004)
	int                                                RTVideoTextures;                                          // 0x00E8(0x0004)
	struct FQWord                                      ImportTimeStamp;                                          // 0x00EC(0x0008) (Const, Transient)
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class GFxUI.GFxAction_InvokeLocalized");
		return ptr;
	}
...
public:
	...
	unsigned long                                      bMovieStarted : 1;                                        // 0x0170(0x0004)
...
{
public:
	class USwfMovie*                                   Movie;                                                    // 0x0178(0x0008) (Edit)
	struct FString                                     FSCommand;                                                // 0x0180(0x0010) (Edit, NeedCtorLink)
	class UGFxFSCmdHandler_Kismet*                     Handler;                                                  // 0x0190(0x0008)
...
{
public:
	struct FScriptDelegate                             __EventListener__Delegate;                                // 0x00A8(0x0010) (NeedCtorLink)
