...
#define CONST_UndefinedModifierFlag                              128
#define CONST_WetModifierFlag                                    64
...
// Enum Engine.Actor.DebugDisplayType
enum class EDebugDisplayType : uint8_t
{
	DDT_Transient                  = 0,
	DDT_Persistent                 = 1,
	DDT_TimeStepPersistent         = 2,
	DDT_MAX                        = 3
};
...
// Enum Engine.AnimatedMesh.EAnimatedMeshType
enum class EAnimatedMeshType : uint8_t
{
	AMT_Mesh                       = 0,
	AMT_Fluid                      = 1,
	AMT_MAX                        = 2
...
enum class EBlendMode : uint8_t
{
	...
	BLEND_WindowTranslucent        = 9,
	BLEND_WindowModulate           = 10,
	BLEND_MAX                      = 11
};
...
enum class ETextureCompressionSettings : uint8_t
{
	...
	TC_NormalmapAlpha              = 3,
	TC_NormalmapRoughnessAlpha     = 4,
	TC_Grayscale                   = 5,
	TC_GrayscaleUncompressed       = 6,
	TC_HighDynamicRange            = 7,
	TC_OneBitAlpha                 = 8,
	TC_NormalmapUncompressed       = 9,
	TC_NormalmapBC5                = 10,
	TC_OneBitMonochrome            = 11,
	TC_SimpleLightmapModification  = 12,
	TC_VectorDisplacementmap       = 13,
	TC_TwoChannels                 = 14,
	TC_MAX                         = 15
};
...
enum class ETextureGroup : uint8_t
{
	...
	TEXTUREGROUP_WorldMask         = 2,
	TEXTUREGROUP_Character         = 3,
	TEXTUREGROUP_CharacterNormalMap = 4,
	TEXTUREGROUP_CharacterMask     = 5,
	...
	TEXTUREGROUP_EnvironmentReflection = 28,
	TEXTUREGROUP_EnvironmentReflectionExterior = 29,
	TEXTUREGROUP_MAX               = 30
};
...
enum class ETextureMipGenSettings : uint8_t
{
	...
	TMGS_Blur4                     = 18,
	TMGS_Blur5                     = 19,
	TMGS_DilateAlpha1              = 20,
	TMGS_DilateAlpha2              = 21,
	TMGS_DilateAlpha3              = 22,
	TMGS_DilateAlpha4              = 23,
	TMGS_DilateAlpha5              = 24,
	TMGS_MAX                       = 25
};
...
// Enum Engine.LightComponent.EShadowMapResolutionHint
enum class EShadowMapResolutionHint : uint8_t
{
	SMR_Normal                     = 0,
	SMR_Half                       = 1,
	SMR_Double                     = 2,
...
// Enum Engine.EnvironmentReflectionComponent.EEnvironmentReflectionUsage
enum class EEnvironmentReflectionUsage : uint8_t
{
	ERU_Interior                   = 0,
	ERU_Exterior                   = 1,
	ERU_FakeWater                  = 2,
...
// Enum Engine.LandscapeWaterInfluenceComponent.ELandscapeWaterInfluenceType
enum class ELandscapeWaterInfluenceType : uint8_t
{
	LWIT_Raindrops                 = 0,
	LWIT_Wave                      = 1,
	LWIT_Sphere                    = 2,
...
enum class EProfileSettingID : uint8_t
{
	...
	PSI_YInversion                 = 2,
	PSI_ControllerSensitivity      = 3,
	PSI_ProfileVersionNum          = 4,
	PSI_ProfileSaveCount           = 5,
	PSI_GammaSetting               = 6,
	PSI_TextureQuality             = 7,
	PSI_FilteringQuality           = 8,
	PSI_ShadowsQuality             = 9,
	PSI_GeometryQuality            = 10,
	PSI_DOFQuality                 = 11,
	PSI_FogQuality                 = 12,
	PSI_AntialiasingQuality        = 13,
	PSI_EffectsQuality             = 14,
	PSI_MotionBlur                 = 15,
	PSI_VSync                      = 16,
	PSI_Fullscreen                 = 17,
	PSI_Resolution                 = 18,
	PSI_GraphicSetupSeparator      = 19,
	PSI_GraphicSetup               = 20,
	PSI_GamepadConfig              = 21,
	PSI_KB_MoveForward             = 22,
	PSI_KB_MoveBackward            = 23,
	PSI_KB_TurnLeft                = 24,
	PSI_KB_TurnRight               = 25,
	PSI_KB_StrafeLeft              = 26,
	PSI_KB_StrafeRight             = 27,
	PSI_KB_Crouch                  = 28,
	PSI_KB_CrawlToggle             = 29,
	PSI_KB_Use                     = 30,
	PSI_KB_Run                     = 31,
	PSI_KB_ToggleCamcorder         = 32,
	PSI_KB_ToggleNightVision       = 33,
	PSI_KB_ToggleMicrophone        = 34,
	PSI_KB_LeanLeft                = 35,
	PSI_KB_LeanRight               = 36,
	PSI_KB_Lookback                = 37,
	PSI_KB_ZoomImpulseIn           = 38,
	PSI_KB_ZoomImpulseOut          = 39,
	PSI_KB_Reload                  = 40,
	PSI_KB_Bandage                 = 41,
	PSI_KB_Jump                    = 42,
	PSI_KB_ToggleInventory         = 43,
	PSI_KB_ShowMenu                = 44,
	PSI_Volume                     = 45,
	PSI_Subtitles                  = 46,
	PSI_Tutorials                  = 47,
	PSI_ShowCrosshair              = 48,
	PSI_Language                   = 49,
	PSI_ToggleCrouch               = 50,
	PSI_ShowPrompts                = 51,
	PSI_Southpaw                   = 52,
	PSI_ViewStabilization          = 53,
	PSI_NoFailStruggle             = 54,
	PSI_GammaInitialized           = 55,
	PSI_LastCheckpointId           = 56,
	PSI_FinishedGame               = 57,
	PSI_FinishedDLC                = 58,
	PSI_ResolutionX                = 59,
	PSI_ResolutionY                = 60,
	PSI_BorderlessFullscreen       = 61,
	PSI_TripleBuffering            = 62,
	PSI_RecordingsPart1            = 63,
	PSI_RecordingsPart2            = 64,
	PSI_MAX                        = 65
};
...
// Enum Engine.PlayerInput.EGamepadType
...
// Enum Engine.SeqAct_Interp.GameFlowMatineeAction
enum class EGameFlowMatineeAction : uint8_t
{
	GFMA_SeekToStart               = 0,
	GFMA_SeekToEnd                 = 1,
	GFMA_MAX                       = 2
...
// Enum Engine.SeqAct_ToggleCinematicMode.CinematicExitStance
enum class ECinematicExitStance : uint8_t
{
	CES_Stand                      = 0,
	CES_Crouch                     = 1,
	CES_Crawl                      = 2,
...
// Enum Engine.SkeletalMesh.MaterialExpressionType
enum class EMaterialExpressionType : uint8_t
{
	MET_ParentTranslation          = 0,
	MET_ParentAxisX                = 1,
	MET_ParentAxisY                = 2,
	MET_ParentAxisZ                = 3,
	MET_LocalTranslation           = 4,
	MET_LocalAxisX                 = 5,
	MET_LocalAxisY                 = 6,
	MET_LocalAxisZ                 = 7,
	MET_WorldTranslation           = 8,
	MET_WorldAxisX                 = 9,
	MET_WorldAxisY                 = 10,
	MET_WorldAxisZ                 = 11,
	MET_ReferenceTranslation       = 12,
	MET_ReferenceAxisX             = 13,
	MET_ReferenceAxisY             = 14,
	MET_ReferenceAxisZ             = 15,
	MET_RemapDifferenceFromReferenceTranslationX = 16,
	MET_RemapDifferenceFromReferenceTranslationY = 17,
	MET_RemapDifferenceFromReferenceTranslationZ = 18,
	MET_RemapDifferenceFromReferenceAxisX = 19,
	MET_RemapDifferenceFromReferenceAxisY = 20,
	MET_RemapDifferenceFromReferenceAxisZ = 21,
	MET_MAX                        = 22
};
...
enum class ETriangleSortOption : uint8_t
{
	...
	TRISORT_CenterRadialDistanceMin = 2,
	TRISORT_CenterRadialDistanceMax = 3,
	TRISORT_Random                 = 4,
	TRISORT_MergeContiguous        = 5,
	TRISORT_Custom                 = 6,
	TRISORT_CustomLeftRight        = 7,
	TRISORT_MAX                    = 8
};
...
{
	Tonemapper_Off                 = 0,
	Tonemapper_Uncharted2          = 1,
	Tonemapper_RedBarrels          = 2,
	Tonemapper_MAX                 = 3
};
...
// Enum Engine.VolumetricFogLightComponent.EVolumetricFogLightType
enum class EVolumetricFogLightType : uint8_t
{
	VFLT_Point                     = 0,
	VFLT_Spot                      = 1,
	VFLT_Planar                    = 2,
...
struct FPostProcessSettings
{
	...
	unsigned long                                      bOverride_Flare_Intensity : 1;                            // 0x0000(0x0004)
	unsigned long                                      bOverride_Flare_Tint0 : 1;                                // 0x0000(0x0004)
	unsigned long                                      bOverride_Flare_Tint1 : 1;                                // 0x0000(0x0004)
	unsigned long                                      bOverride_Flare_Tint2 : 1;                                // 0x0000(0x0004)
	unsigned long                                      bOverride_Flare_Tint3 : 1;                                // 0x0000(0x0004)
	unsigned long                                      bOverride_LensDirt_Tint : 1;                              // 0x0000(0x0004)
	...
	unsigned long                                      bOverride_DOF_BokehShape : 1;                             // 0x0000(0x0004)
	unsigned long                                      bOverride_DOF_BokehRotation : 1;                          // 0x0000(0x0004)
	unsigned long                                      bOverride_DOF_UnderwaterBlur : 1;                         // 0x0000(0x0004)
	unsigned long                                      bOverride_MotionBlur_MaxVelocity : 1;                     // 0x0000(0x0004)
	unsigned long                                      bOverride_MotionBlur_Amount : 1;                          // 0x0004(0x0004)
	unsigned long                                      bOverride_MotionBlur_FullMotionBlur : 1;                  // 0x0004(0x0004)
	unsigned long                                      bOverride_MotionBlur_CameraRotationThreshold : 1;         // 0x0004(0x0004)
	unsigned long                                      bOverride_MotionBlur_CameraTranslationThreshold : 1;      // 0x0004(0x0004)
	unsigned long                                      bOverride_MotionBlur_InterpolationDuration : 1;           // 0x0004(0x0004)
	unsigned long                                      bOverride_Scene_VignetteIntensity : 1;                    // 0x0004(0x0004)
	unsigned long                                      bOverride_Scene_Desaturation : 1;                         // 0x0004(0x0004)
	unsigned long                                      bOverride_Scene_Colorize : 1;                             // 0x0004(0x0004)
	unsigned long                                      bOverride_Scene_TonemapperWhitePoint : 1;                 // 0x0004(0x0004)
	unsigned long                                      bOverride_Scene_TonemapperToeCutoff : 1;                  // 0x0004(0x0004)
	unsigned long                                      bOverride_Scene_TonemapperShoulderCutoff : 1;             // 0x0004(0x0004)
	unsigned long                                      bOverride_Scene_TonemapperMidTones : 1;                   // 0x0004(0x0004)
	...
	unsigned long                                      bOverride_Scene_ExponentBias : 1;                         // 0x0004(0x0004)
	unsigned long                                      bOverride_Scene_ModShadowAmbientDirection : 1;            // 0x0004(0x0004)
	unsigned long                                      bOverride_EyeAdaptation_ManualExposure : 1;               // 0x0004(0x0004)
	unsigned long                                      bOverride_EyeAdaptation_AdaptationMin : 1;                // 0x0004(0x0004)
	unsigned long                                      bOverride_EyeAdaptation_AdaptationMax : 1;                // 0x0004(0x0004)
	unsigned long                                      bOverride_EyeAdaptation_AdaptationSpeedDown : 1;          // 0x0004(0x0004)
	unsigned long                                      bOverride_EyeAdaptation_AdaptationSpeedUp : 1;            // 0x0004(0x0004)
	unsigned long                                      bOverride_CamAdaptation_ManualExposure : 1;               // 0x0004(0x0004)
	unsigned long                                      bOverride_CamAdaptation_AdaptationMin : 1;                // 0x0004(0x0004)
	unsigned long                                      bOverride_CamAdaptation_AdaptationMax : 1;                // 0x0004(0x0004)
	unsigned long                                      bOverride_CamAdaptation_AdaptationSpeedDown : 1;          // 0x0004(0x0004)
	unsigned long                                      bOverride_CamAdaptation_AdaptationSpeedUp : 1;            // 0x0004(0x0004)
	unsigned long                                      bOverride_NVAdaptation_ManualExposure : 1;                // 0x0004(0x0004)
	unsigned long                                      bOverride_NVAdaptation_AdaptationMin : 1;                 // 0x0004(0x0004)
	unsigned long                                      bOverride_NVAdaptation_AdaptationMax : 1;                 // 0x0008(0x0004)
	unsigned long                                      bOverride_NVAdaptation_AdaptationSpeedDown : 1;           // 0x0008(0x0004)
	unsigned long                                      bOverride_NVAdaptation_AdaptationSpeedUp : 1;             // 0x0008(0x0004)
	unsigned long                                      bOverride_RimShader_Color : 1;                            // 0x0008(0x0004)
	unsigned long                                      bOverride_RimShader_InterpolationDuration : 1;            // 0x0008(0x0004)
	unsigned long                                      bOverride_MobileColorGrading : 1;                         // 0x0008(0x0004)
	unsigned long                                      bOverride_Occlusion_CavityInfluence : 1;                  // 0x0008(0x0004)
	unsigned long                                      bOverride_Occlusion_ReflectivityInfluence : 1;            // 0x0008(0x0004)
	unsigned long                                      bOverride_TemporalAA_LowFrequencyPersistence : 1;         // 0x0008(0x0004)
	unsigned long                                      bOverride_TemporalAA_HighFrequencyPersistence : 1;        // 0x0008(0x0004)
	unsigned long                                      bOverride_AmbientOcclusion_NightVisionShadowCenter : 1;   // 0x0008(0x0004)
	unsigned long                                      bOverride_AmbientOcclusion_NightVisionTraceDistance : 1;  // 0x0008(0x0004)
	unsigned long                                      bOverride_AmbientOcclusion_NightVisionDepthTraceDistance : 1;// 0x0008(0x0004)
	unsigned long                                      bEnableBloom : 1;                                         // 0x0008(0x0004) (Edit)
	unsigned long                                      bEnableDOF : 1;                                           // 0x0008(0x0004) (Edit)
	unsigned long                                      bEnableMotionBlur : 1;                                    // 0x0008(0x0004) (Edit)
	unsigned long                                      bEnableSceneEffect : 1;                                   // 0x0008(0x0004) (Edit)
	unsigned long                                      bAllowAmbientOcclusion : 1;                               // 0x0008(0x0004) (Edit)
	unsigned long                                      bOverrideRimShaderColor : 1;                              // 0x0008(0x0004) (Edit)
	float                                              Bloom_Scale;                                              // 0x000C(0x0004) (Edit)
	float                                              Bloom_Threshold;                                          // 0x0010(0x0004) (Edit)
	struct FColor                                      Bloom_Tint;                                               // 0x0014(0x0004) (Edit)
	float                                              Bloom_InterpolationDuration;                              // 0x0018(0x0004) (Edit)
	float                                              DOF_BlurBloomKernelSize;                                  // 0x001C(0x0004) (Edit)
	float                                              Flare_Intensity;                                          // 0x0020(0x0004) (Edit)
	struct FLinearColor                                Flare_Tint0;                                              // 0x0024(0x0010) (Edit)
	struct FLinearColor                                Flare_Tint1;                                              // 0x0034(0x0010) (Edit)
	struct FLinearColor                                Flare_Tint2;                                              // 0x0044(0x0010) (Edit)
	struct FLinearColor                                Flare_Tint3;                                              // 0x0054(0x0010) (Edit)
	struct FLinearColor                                LensDirt_Tint;                                            // 0x0064(0x0010) (Edit)
	float                                              DOF_FalloffExponent;                                      // 0x0074(0x0004) (Edit)
	float                                              DOF_BlurKernelSize;                                       // 0x0078(0x0004) (Edit)
	float                                              DOF_MaxNearBlurAmount;                                    // 0x007C(0x0004) (Edit)
	float                                              DOF_MinBlurAmount;                                        // 0x0080(0x0004) (Edit)
	float                                              DOF_MaxFarBlurAmount;                                     // 0x0084(0x0004) (Edit)
	TEnumAsByte<EFocusType>                            DOF_FocusType;                                            // 0x0088(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0089(0x0003) MISSED OFFSET
	float                                              DOF_FocusInnerRadius;                                     // 0x008C(0x0004) (Edit)
	float                                              DOF_FocusDistance;                                        // 0x0090(0x0004) (Edit)
	struct FVector                                     DOF_FocusPosition;                                        // 0x0094(0x000C) (Edit)
	float                                              DOF_InterpolationDuration;                                // 0x00A0(0x0004) (Edit)
	class UTexture2D*                                  DOF_BokehTexture;                                         // 0x00A4(0x0008) (Edit)
	float                                              DOF_BokehShape;                                           // 0x00AC(0x0004) (Edit)
	float                                              DOF_BokehRotation;                                        // 0x00B0(0x0004) (Edit)
	float                                              DOF_UnderwaterBlur;                                       // 0x00B4(0x0004) (Edit)
	float                                              MotionBlur_MaxVelocity;                                   // 0x00B8(0x0004) (Edit)
	float                                              MotionBlur_Amount;                                        // 0x00BC(0x0004) (Edit)
	unsigned long                                      MotionBlur_FullMotionBlur : 1;                            // 0x00C0(0x0004) (Edit)
	float                                              MotionBlur_CameraRotationThreshold;                       // 0x00C4(0x0004) (Edit)
	float                                              MotionBlur_CameraTranslationThreshold;                    // 0x00C8(0x0004) (Edit)
	float                                              MotionBlur_InterpolationDuration;                         // 0x00CC(0x0004) (Edit)
	float                                              Scene_VignetteIntensity;                                  // 0x00D0(0x0004) (Edit)
	float                                              Scene_Desaturation;                                       // 0x00D4(0x0004) (Edit)
	struct FVector                                     Scene_Colorize;                                           // 0x00D8(0x000C) (Edit)
	float                                              Scene_TonemapperWhitePoint;                               // 0x00E4(0x0004) (Edit)
	float                                              Scene_TonemapperToeCutoff;                                // 0x00E8(0x0004) (Edit)
	float                                              Scene_TonemapperShoulderCutoff;                           // 0x00EC(0x0004) (Edit)
	float                                              Scene_TonemapperMidTones;                                 // 0x00F0(0x0004) (Edit)
	float                                              Scene_ImageGrainScale;                                    // 0x00F4(0x0004) (Edit)
	struct FVector                                     Scene_HighLights;                                         // 0x00F8(0x000C) (Edit)
	struct FVector                                     Scene_MidTones;                                           // 0x0104(0x000C) (Edit)
	struct FVector                                     Scene_Shadows;                                            // 0x0110(0x000C) (Edit)
	float                                              Scene_InterpolationDuration;                              // 0x011C(0x0004) (Edit)
	float                                              Scene_ExponentBias;                                       // 0x0120(0x0004) (Edit)
	struct FVector                                     Scene_ModShadowAmbientDirection;                          // 0x0124(0x000C) (Edit)
	float                                              EyeAdaptation_ManualExposure;                             // 0x0130(0x0004) (Edit)
	float                                              EyeAdaptation_AdaptationMin;                              // 0x0134(0x0004) (Edit)
	float                                              EyeAdaptation_AdaptationMax;                              // 0x0138(0x0004) (Edit)
	float                                              EyeAdaptation_AdaptationSpeedDown;                        // 0x013C(0x0004) (Edit)
	float                                              EyeAdaptation_AdaptationSpeedUp;                          // 0x0140(0x0004) (Edit)
	float                                              CamAdaptation_ManualExposure;                             // 0x0144(0x0004) (Edit)
	float                                              CamAdaptation_AdaptationMin;                              // 0x0148(0x0004) (Edit)
	float                                              CamAdaptation_AdaptationMax;                              // 0x014C(0x0004) (Edit)
	float                                              CamAdaptation_AdaptationSpeedDown;                        // 0x0150(0x0004) (Edit)
	float                                              CamAdaptation_AdaptationSpeedUp;                          // 0x0154(0x0004) (Edit)
	float                                              NVAdaptation_ManualExposure;                              // 0x0158(0x0004) (Edit)
	float                                              NVAdaptation_AdaptationMin;                               // 0x015C(0x0004) (Edit)
	float                                              NVAdaptation_AdaptationMax;                               // 0x0160(0x0004) (Edit)
	float                                              NVAdaptation_AdaptationSpeedDown;                         // 0x0164(0x0004) (Edit)
	float                                              NVAdaptation_AdaptationSpeedUp;                           // 0x0168(0x0004) (Edit)
	float                                              Occlusion_CavityInfluence;                                // 0x016C(0x0004) (Edit)
	float                                              Occlusion_ReflectivityInfluence;                          // 0x0170(0x0004) (Edit)
	float                                              TemporalAA_LowFrequencyPersistence;                       // 0x0174(0x0004) (Edit)
	float                                              TemporalAA_HighFrequencyPersistence;                      // 0x0178(0x0004) (Edit)
	struct FVector2D                                   AmbientOcclusion_NightVisionShadowCenter;                 // 0x017C(0x0008) (Edit)
	float                                              AmbientOcclusion_NightVisionTraceDistance;                // 0x0184(0x0004) (Edit)
	float                                              AmbientOcclusion_NightVisionDepthTraceDistance;           // 0x0188(0x0004) (Edit)
	struct FLinearColor                                RimShader_Color;                                          // 0x018C(0x0010) (Edit)
	float                                              RimShader_InterpolationDuration;                          // 0x019C(0x0004) (Edit)
	class UTexture*                                    ColorGrading_LookupTable;                                 // 0x01A0(0x0008) (Edit)
	struct FLUTBlender                                 ColorGradingLUT;                                          // 0x01A8(0x0024) (Const, Transient, NeedCtorLink)
	struct FMobileColorGradingParams                   MobileColorGrading;                                       // 0x01CC(0x003C) (Edit)
	struct FMobilePostProcessSettings                  MobilePostProcess;                                        // 0x0208(0x0034) (Edit)
};
...
struct FLightmassWorldInfoSettings
{
	...
	float                                              StaticLightingLevelScalePreview;                          // 0x0004(0x0004) (Edit)
	int                                                NumIndirectLightingBounces;                               // 0x0008(0x0004) (Edit)
	float                                              IndirectLightingSmoothness;                               // 0x000C(0x0004) (Edit)
	struct FColor                                      EnvironmentColor;                                         // 0x0010(0x0004) (Edit)
	struct FColor                                      EnvironmentColorBottom;                                   // 0x0014(0x0004) (Edit)
	float                                              EnvironmentIntensity;                                     // 0x0018(0x0004) (Edit)
	unsigned long                                      bDisablePreviewSkylight : 1;                              // 0x001C(0x0004) (Edit)
	float                                              EmissiveBoost;                                            // 0x0020(0x0004) (Edit)
	float                                              DiffuseBoost;                                             // 0x0024(0x0004) (Edit)
	unsigned long                                      bUseAmbientOcclusion : 1;                                 // 0x0028(0x0004) (Edit)
	unsigned long                                      bEnableImageReflectionShadowing : 1;                      // 0x0028(0x0004)
	...
	unsigned long                                      bUseLargeScaleAmbientOcclusion : 1;                       // 0x0038(0x0004) (Edit)
	float                                              LargeScaleOcclusionExponent;                              // 0x003C(0x0004) (Edit)
	float                                              LargeScaleFullyOccludedSamplesFraction;                   // 0x0040(0x0004) (Edit)
	float                                              LargeScaleMaxOcclusionDistance;                           // 0x0044(0x0004) (Edit)
	unsigned long                                      bForceProductionQualityAmbientOcclusion : 1;              // 0x0048(0x0004) (Edit)
	float                                              FogDensity;                                               // 0x004C(0x0004) (Edit)
	unsigned long                                      bVisualizeMaterialDiffuse : 1;                            // 0x0050(0x0004)
	unsigned long                                      bVisualizeAmbientOcclusion : 1;                           // 0x0050(0x0004)
	unsigned long                                      bCompressShadowmap : 1;                                   // 0x0050(0x0004)
};
...
{
	TEnumAsByte<EGameFlowEnableAction>                 Action;                                                   // 0x0000(0x0001) (Edit)
...
{
	unsigned long                                      Exterior : 1;                                             // 0x0000(0x0004) (Edit)
	unsigned long                                      Interior1 : 1;                                            // 0x0000(0x0004) (Edit)
	unsigned long                                      Interior2 : 1;                                            // 0x0000(0x0004) (Edit)
};
...
struct FLightingChannelContainer
{
	...
	unsigned long                                      NotPlayer : 1;                                            // 0x0000(0x0004) (Edit)
	...
	unsigned long                                      Dynamic_2 : 1;                                            // 0x0000(0x0004)
	unsigned long                                      Dynamic_3 : 1;                                            // 0x0000(0x0004)
	unsigned long                                      Dynamic_4 : 1;                                            // 0x0000(0x0004)
	unsigned long                                      Dynamic_5 : 1;                                            // 0x0000(0x0004)
	unsigned long                                      Dynamic_6 : 1;                                            // 0x0000(0x0004)
...
struct FIdToStringMapping
{
	...
	struct FName                                       TextId;                                                   // 0x0004(0x0008) (Const)
};
...
struct FRenderingPerformanceOverrides
{
	...
	unsigned long                                      bAllowModShadows : 1;                                     // 0x0000(0x0004) (Edit)
	unsigned long                                      bAllowDistortion : 1;                                     // 0x0000(0x0004) (Edit)
	unsigned long                                      bAllowWater : 1;                                          // 0x0000(0x0004) (Edit)
	unsigned long                                      bAllowReflectionShadows : 1;                              // 0x0000(0x0004) (Edit)
	unsigned long                                      bStandardDepthPrepass : 1;                                // 0x0000(0x0004) (Edit)
};
...
struct FLightmassPrimitiveSettings
{
	...
	unsigned long                                      bUseSinglePointLighting : 1;                              // 0x0000(0x0004) (Edit)
	unsigned long                                      bApplyWorldPositionOffset : 1;                            // 0x0000(0x0004) (Edit)
	unsigned long                                      bIgnoreForAO : 1;                                         // 0x0000(0x0004) (Edit)
	unsigned long                                      bIgnoreLargeScaleAO : 1;                                  // 0x0000(0x0004) (Edit)
	float                                              SinglePointLightingScale;                                 // 0x0004(0x0004) (Edit)
	float                                              EmissiveLightFalloffExponent;                             // 0x0008(0x0004) (Edit)
	float                                              EmissiveLightExplicitInfluenceRadius;                     // 0x000C(0x0004) (Edit)
	float                                              EmissiveBoost;                                            // 0x0010(0x0004) (Edit)
	float                                              DiffuseBoost;                                             // 0x0014(0x0004) (Edit)
	float                                              SpecularBoost;                                            // 0x0018(0x0004)
	float                                              FullyOccludedSamplesFraction;                             // 0x001C(0x0004) (Edit)
	float                                              LargeScaleFullyOccludedSamplesFraction;                   // 0x0020(0x0004) (Edit)
};
...
struct FBaseAuthSession
{
	...
	struct FUniqueNetId                                EndPointUID;                                              // 0x0018(0x0010) (Const)
};
...
{
	int                                                SessionUID;                                               // 0x0028(0x0004) (Const)
};
...
{
	TEnumAsByte<EAuthStatus>                           AuthStatus;                                               // 0x0028(0x0001) (Const)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0029(0x0003) MISSED OFFSET
	int                                                AuthTicketUID;                                            // 0x002C(0x0004) (Const)
};
...
struct FOnlineProfileSetting
{
	...
	unsigned char                                      UnknownData00[0x3];                                       // 0x0001(0x0003) MISSED OFFSET
	struct FSettingsProperty                           ProfileSetting;                                           // 0x0004(0x0020)
};
...
{
	struct FPostProcessSettings                        LastSettings;                                             // 0x0000(0x023C) (NeedCtorLink)
	class APostProcessVolume*                          LastVolumeUsed;                                           // 0x023C(0x0008)
	float                                              BlendStartTime;                                           // 0x0244(0x0004)
	float                                              LastBlendTime;                                            // 0x0248(0x0004)
};
...
{
	struct FPostProcessSettings                        Settings;                                                 // 0x0000(0x023C) (NeedCtorLink)
	unsigned long                                      bBlendingIn : 1;                                          // 0x023C(0x0004)
	unsigned long                                      bBlendingOut : 1;                                         // 0x023C(0x0004)
	float                                              CurrentBlendInTime;                                       // 0x0240(0x0004)
	float                                              CurrentBlendOutTime;                                      // 0x0244(0x0004)
	float                                              BlendInDuration;                                          // 0x0248(0x0004)
	float                                              BlendOutDuration;                                         // 0x024C(0x0004)
	float                                              BlendStartTime;                                           // 0x0250(0x0004)
	struct FInterpCurveFloat                           TimeAlphaCurve;                                           // 0x0254(0x0014) (NeedCtorLink)
};
...
{
	struct FName                                       BoneNamePattern;                                          // 0x0000(0x0008) (Edit)
	float                                              Radius;                                                   // 0x0008(0x0004) (Edit, Native)
	float                                              Stiffness;                                                // 0x000C(0x0004) (Edit, Native)
	float                                              Damping;                                                  // 0x0010(0x0004) (Edit, Native)
	float                                              Mass;                                                     // 0x0014(0x0004) (Edit, Native)
	float                                              Displacement;                                             // 0x0018(0x0004) (Edit, Native)
};
...
struct FStaticMeshLODElement
{
	...
	unsigned long                                      UnknownData01 : 31;                                       // 0x0010(0x0001)
	unsigned long                                      bReflectionShadowMask : 1;                                // 0x0014(0x0004) (Edit, Native)
	unsigned long                                      UnknownData02 : 31;                                       // 0x0014(0x0001)
	unsigned long                                      bCastNightVisionShadow : 1;                               // 0x0018(0x0004) (Edit, Native)
};
...
struct FPhysEffectInfo
{
	...
	float                                              AINoise;                                                  // 0x0018(0x0004) (Edit)
};
...
struct FStaticMeshComponentLODInfo
{
	...
	TArray<struct FGuid>                               IrrelevantLights;                                         // 0x0028(0x0010) (Const, NeedCtorLink)
	struct FPointer                                    OverrideVertexColors;                                     // 0x0038(0x0008) (Const, Native)
	TArray<struct FPaintedVertex>                      PaintedVertices;                                          // 0x0040(0x0010) (Const, NeedCtorLink)
};
...
{
	unsigned long                                      bLeftFoot : 1;                                            // 0x0000(0x0004) (Edit)
	float                                              TimeDown;                                                 // 0x0004(0x0004) (Edit)
	float                                              TimeUp;                                                   // 0x0008(0x0004) (Edit)
};
...
{
	struct FVector                                     CoordScale;                                               // 0x0000(0x000C) (Edit, Const)
	struct FVector                                     CoordBias;                                                // 0x000C(0x000C) (Edit, Const)
	int                                                NumVertices;                                              // 0x0018(0x0004) (Edit, Const)
	int                                                NumIndices;                                               // 0x001C(0x0004) (Edit, Const)
	TArray<unsigned char>                              VertexData;                                               // 0x0020(0x0010) (Const, NeedCtorLink)
	TArray<unsigned char>                              IndexData;                                                // 0x0030(0x0010) (Const, NeedCtorLink)
	struct FPointer                                    VertexBuffer;                                             // 0x0040(0x0008) (Const, Native)
	struct FPointer                                    IndexBuffer;                                              // 0x0048(0x0008) (Const, Native)
};
...
{
	class ULightComponent*                             Light;                                                    // 0x0000(0x0008) (ExportObject, Component, EditInline)
};
...
struct FMaterialReferenceList
{
	...
	TArray<struct FLightMaterialRef>                   AffectedLightMaterialRefs;                                // 0x0028(0x0010) (Component, NeedCtorLink)
};
...
{
	TEnumAsByte<EGameFlowMatineeAction>                Action;                                                   // 0x0000(0x0001) (Edit)
	TEnumAsByte<EGameFlowCondition>                    Condition;                                                // 0x0001(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0002(0x0002) MISSED OFFSET
	struct FName                                       ControlName;                                              // 0x0004(0x0008) (Edit)
	struct FName                                       RangeEndCheckpoint;                                       // 0x000C(0x0008) (Edit)
...
struct FTextureGroupContainer
{
	...
	unsigned long                                      TEXTUREGROUP_WorldMask : 1;                               // 0x0000(0x0004) (Edit, Const)
	...
	unsigned long                                      TEXTUREGROUP_CharacterMask : 1;                           // 0x0000(0x0004) (Edit, Const)
	...
	unsigned long                                      TEXTUREGROUP_EnvironmentReflection : 1;                   // 0x0000(0x0004) (Edit, Const)
	unsigned long                                      TEXTUREGROUP_EnvironmentReflectionExterior : 1;           // 0x0000(0x0004) (Edit, Const)
};
...
struct FLandscapeLayerMapping
{
	...
	class UPhysicalMaterial*                           WetPhysMaterial;                                          // 0x0010(0x0008)
};
...
struct FKeyIconBinding
{
	...
	struct FName                                       Icon;                                                     // 0x0008(0x0008) (Config)
};
...
struct FFoliageBoneState
{
	...
	float                                              Mass;                                                     // 0x000C(0x0004)
	float                                              Displacement;                                             // 0x0010(0x0004)
	float                                              TouchAlpha;                                               // 0x0014(0x0004)
	unsigned long                                      bTouched : 1;                                             // 0x0018(0x0004)
	unsigned long                                      bActive : 1;                                              // 0x0018(0x0004)
	struct FVector                                     InitialPosition;                                          // 0x001C(0x000C)
	struct FVector                                     DesiredPosition;                                          // 0x0028(0x000C)
	struct FVector                                     CurrentPosition;                                          // 0x0034(0x000C)
	struct FVector                                     Velocity;                                                 // 0x0040(0x000C)
};
...
struct FLightmassDirectionalLightSettings : public FLightmassLightSettings
{
	...
	unsigned long                                      bDistanceFieldShadowMap : 1;                              // 0x0010(0x0004) (Edit)
};
...
struct FLightmassPointLightSettings : public FLightmassLightSettings
{
	...
	unsigned long                                      bBakeIndirectOnMovable : 1;                               // 0x0010(0x0004) (Edit)
	unsigned long                                      bBakeSpotAsPointLight : 1;                                // 0x0010(0x0004) (Edit)
	unsigned long                                      bLargeScaleAOAffectsDirectLighting : 1;                   // 0x0010(0x0004) (Edit)
	float                                              LightRadiusMultiplier;                                    // 0x0014(0x0004) (Edit)
};
...
{
	TArray<struct FName>                               BoneNames;                                                // 0x0000(0x0010) (Edit, NeedCtorLink)
};
...
struct FSkeletalMeshLODInfo
{
	...
	TArray<unsigned long>                              bEnableHiPrecisionShadowCasting;                          // 0x0028(0x0010) (Edit, EditFixedSize, NeedCtorLink)
	TArray<unsigned long>                              bEnableNightVisionShadowCasting;                          // 0x0038(0x0010) (Edit, EditFixedSize, NeedCtorLink)
	TArray<float>                                      MaxDrawDistance;                                          // 0x0048(0x0010) (Edit, EditFixedSize, NeedCtorLink)
	TArray<struct FPerSectionCullingBones>             PerSectionCullingBones;                                   // 0x0058(0x0010) (Edit, EditFixedSize, NeedCtorLink)
	TArray<TEnumAsByte<ETriangleSortOption>>           TriangleSorting;                                          // 0x0068(0x0010) (NeedCtorLink, Deprecated)
	TArray<struct FTriangleSortSettings>               TriangleSortSettings;                                     // 0x0078(0x0010) (Edit, EditFixedSize, NeedCtorLink)
	unsigned long                                      bDisableCompressions : 1;                                 // 0x0088(0x0004) (Edit)
	unsigned long                                      bHasBeenSimplified : 1;                                   // 0x0088(0x0004)
};
...
{
	struct FName                                       BoneName;                                                 // 0x0000(0x0008) (Edit)
	TEnumAsByte<EMaterialExpressionType>               ExpressionType;                                           // 0x0008(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0009(0x0003) MISSED OFFSET
	unsigned long                                      bEnableRemapping : 1;                                     // 0x000C(0x0004) (Edit)
	float                                              InMin;                                                    // 0x0010(0x0004) (Edit)
	float                                              InMax;                                                    // 0x0014(0x0004) (Edit)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0018(0x0008) MISSED OFFSET
	struct FVector4                                    OutMin;                                                   // 0x0020(0x0010) (Edit)
	struct FVector4                                    OutMax;                                                   // 0x0030(0x0010) (Edit)
};
...
{
	float                                              VertexReduction;                                          // 0x0000(0x0004) (Edit)
	TArray<unsigned long>                              bIncludeSection;                                          // 0x0004(0x0010) (Edit, EditFixedSize, NeedCtorLink)
};
...
{
	struct FPRIAudioDeviceInfo                         AudioDevices[0x8];                                        // 0x0000(0x001C) (NeedCtorLink)
	unsigned long                                      IsGuest : 1;                                              // 0x00E0(0x0004)
	struct FString                                     UserId;                                                   // 0x00E4(0x0010) (AlwaysInit, NeedCtorLink)
};
...
struct FCommunityContentFile
{
	...
	struct FUniqueNetId                                Owner;                                                    // 0x001C(0x0010)
	int                                                DownloadCount;                                            // 0x002C(0x0004)
	float                                              AverageRating;                                            // 0x0030(0x0004)
	int                                                RatingCount;                                              // 0x0034(0x0004)
	int                                                LastRatingGiven;                                          // 0x0038(0x0004)
	struct FString                                     LocalFilePath;                                            // 0x003C(0x0010) (NeedCtorLink)
};
...
struct FMarketplaceProductAvailability
{
	...
	struct FString                                     PromotionalText;                                          // 0x007C(0x0010) (Const, NeedCtorLink)
	struct FString                                     SignedOffer;                                              // 0x008C(0x0010) (Const, NeedCtorLink)
};
...
struct FMarketplaceProductDetails
{
	...
	TArray<struct FMarketplaceProductImage>            Images;                                                   // 0x0050(0x0010) (Const, NeedCtorLink)
	TEnumAsByte<EOnlineEnumerationReadState>           DetailsReadState;                                         // 0x0060(0x0001)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0061(0x0003) MISSED OFFSET
	TArray<struct FMarketplaceProductAvailability>     Availabilities;                                           // 0x0064(0x0010) (Const, NeedCtorLink)
	struct FString                                     ProductDescription;                                       // 0x0074(0x0010) (Const, NeedCtorLink)
};
...
struct FSessionMemberInfo
{
	...
	TEnumAsByte<ESessionMemberStatus>                  MemberStatus;                                             // 0x0010(0x0001)
};
...
struct FTexture2DMipMap
{
	...
	int                                                SizeX;                                                    // 0x0050(0x0004) (Native)
	int                                                SizeY;                                                    // 0x0054(0x0004) (Native)
};
