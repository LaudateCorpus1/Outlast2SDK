...
void AGameAIController::TestLogAIToConsole(int Verbosity)
{
	static auto fn = UObject::FindObject<UFunction>("Function GameFramework.GameAIController.TestLogAIToConsole");

	AGameAIController_TestLogAIToConsole_Params params;
