...
// (Final, Native, Public)
// Parameters:
// bool                           bConvertInput                  (Parm)

void UGFxMoviePlayer::SetMovieConvertMovementInputToUIInput(bool bConvertInput)
{
	static auto fn = UObject::FindObject<UFunction>("Function GFxUI.GFxMoviePlayer.SetMovieConvertMovementInputToUIInput");

	UGFxMoviePlayer_SetMovieConvertMovementInputToUIInput_Params params;
	params.bConvertInput = bConvertInput;
...
bool UGFxAction_InvokeLocalized::IsValidLevelSequenceObject()
{
	static auto fn = UObject::FindObject<UFunction>("Function GFxUI.GFxAction_InvokeLocalized.IsValidLevelSequenceObject");

	UGFxAction_InvokeLocalized_IsValidLevelSequenceObject_Params params;
