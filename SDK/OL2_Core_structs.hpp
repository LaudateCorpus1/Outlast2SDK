...
{
	TEnumAsByte<EGameFlowVisibilityAction>             Action;                                                   // 0x0000(0x0001) (Edit)
...
struct FSpinLock
{
	int                                                Counter;                                                  // 0x0000(0x0004) (Const)
};
...
struct FUntypedBulkData_Mirror
{
	...
	struct FQWord                                      BulkDataOffsetInFile;                                     // 0x0010(0x0008) (Const, Native)
	struct FQWord                                      BulkDataSizeOnDisk;                                       // 0x0018(0x0008) (Const, Native)
	int                                                SavedBulkDataFlags;                                       // 0x0020(0x0004) (Const, Native)
	int                                                SavedElementCount;                                        // 0x0024(0x0004) (Const, Native)
	struct FQWord                                      SavedBulkDataOffsetInFile;                                // 0x0028(0x0008) (Const, Native)
	struct FQWord                                      SavedBulkDataSizeOnDisk;                                  // 0x0030(0x0008) (Const, Native)
	struct FPointer                                    BulkData;                                                 // 0x0038(0x0008) (Const, Native)
	int                                                LockStatus;                                               // 0x0040(0x0004) (Const, Native)
	struct FPointer                                    AttachedAr;                                               // 0x0044(0x0008) (Const, Native)
	int                                                bShouldFreeOnEmpty;                                       // 0x004C(0x0004) (Const, Native)
};
