...
{
public:
	int                                                BeaconPort;                                               // 0x0068(0x0004)
	struct FName                                       BeaconName;                                               // 0x006C(0x0008)
...
// 0x0130 (0x0BDC - 0x0AAC)
class UHTTPDownload : public UDownload
{
public:
	struct FString                                     ProxyServerHost;                                          // 0x0AAC(0x0010) (Config, NeedCtorLink)
	int                                                ProxyServerPort;                                          // 0x0ABC(0x0004) (Config)
	unsigned long                                      MaxRedirection : 1;                                       // 0x0AC0(0x0004) (Config)
	float                                              ConnectionTimeout;                                        // 0x0AC4(0x0004) (Config)
	unsigned char                                      UnknownData00[0x114];                                     // 0x0AC8(0x0114) MISSED OFFSET
...
{
public:
	TEnumAsByte<ELinkMode>                             LinkMode;                                                 // 0x0248(0x0001)
	TEnumAsByte<ELineMode>                             InLineMode;                                               // 0x0249(0x0001)
	TEnumAsByte<ELineMode>                             OutLineMode;                                              // 0x024A(0x0001)
	TEnumAsByte<EReceiveMode>                          ReceiveMode;                                              // 0x024B(0x0001)
	struct FPointer                                    Socket;                                                   // 0x024C(0x0008) (Const)
	int                                                Port;                                                     // 0x0254(0x0004) (Const)
	struct FPointer                                    RemoteSocket;                                             // 0x0258(0x0008) (Const)
	struct FPointer                                    PrivateResolveInfo;                                       // 0x0260(0x0008) (Const, Native)
	int                                                DataPending;                                              // 0x0268(0x0004) (Const)
...
{
public:
	TEnumAsByte<ELinkState>                            LinkState;                                                // 0x026C(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x026D(0x0003) MISSED OFFSET
	struct FIpAddr                                     RemoteAddr;                                               // 0x0270(0x0014)
	class UClass*                                      AcceptClass;                                              // 0x0284(0x0008)
	TArray<unsigned char>                              SendFIFO;                                                 // 0x028C(0x0010) (Const, NeedCtorLink)
	struct FString                                     RecvBuf;                                                  // 0x029C(0x0010) (Const, NeedCtorLink)
...
{
public:
	struct FString                                     McpConfigClassName;                                       // 0x0068(0x0010) (Config, NeedCtorLink)
	class UMcpServiceConfig*                           McpConfig;                                                // 0x0078(0x0008)
...
{
public:
	TArray<struct FEventUploadConfig>                  EventUploadConfigs;                                       // 0x0088(0x0010) (Const, Config, NeedCtorLink)
	TArray<struct FPointer>                            MCPEventPostObjects;                                      // 0x0098(0x0010) (Const, Native)
	TArray<TEnumAsByte<EEventUploadType>>              DisabledUploadTypes;                                      // 0x00A8(0x0010) (Config, NeedCtorLink)
	unsigned long                                      bBinaryStats : 1;                                         // 0x00B8(0x0004) (Const, Config)
...
{
public:
	TArray<struct FNewsCacheEntry>                     NewsItems;                                                // 0x0088(0x0010) (Config, NeedCtorLink)
	TArray<struct FScriptDelegate>                     ReadNewsDelegates;                                        // 0x0098(0x0010) (NeedCtorLink)
	unsigned long                                      bNeedsTicking : 1;                                        // 0x00A8(0x0004) (Transient)
	struct FScriptDelegate                             __OnReadNewsCompleted__Delegate;                          // 0x00AC(0x0010) (NeedCtorLink)
...
// 0x0084 (0x010C - 0x0088)
class UOnlineTitleFileDownloadBase : public UMCPBase
{
public:
	TArray<struct FScriptDelegate>                     ReadTitleFileCompleteDelegates;                           // 0x0088(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     RequestTitleFileListCompleteDelegates;                    // 0x0098(0x0010) (NeedCtorLink)
	struct FString                                     BaseUrl;                                                  // 0x00A8(0x0010) (Config, NeedCtorLink)
	struct FString                                     RequestFileListURL;                                       // 0x00B8(0x0010) (Config, NeedCtorLink)
	struct FString                                     RequestFileURL;                                           // 0x00C8(0x0010) (Config, NeedCtorLink)
	float                                              TimeOut;                                                  // 0x00D8(0x0004) (Config)
	TArray<struct FFileNameToURLMapping>               FilesToUrls;                                              // 0x00DC(0x0010) (Config, NeedCtorLink)
	struct FScriptDelegate                             __OnReadTitleFileComplete__Delegate;                      // 0x00EC(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnRequestTitleFileListComplete__Delegate;               // 0x00FC(0x0010) (NeedCtorLink)
...
{
public:
	TArray<struct FTitleFileMcp>                       TitleFiles;                                               // 0x010C(0x0010) (NeedCtorLink)
	int                                                DownloadCount;                                            // 0x011C(0x0004) (Transient)
...
{
public:
	TArray<struct FTitleFileWeb>                       TitleFiles;                                               // 0x010C(0x0010) (NeedCtorLink)
...
{
public:
	TArray<struct FTitleFileCacheEntry>                TitleFiles;                                               // 0x0088(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     LoadCompleteDelegates;                                    // 0x0098(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     SaveCompleteDelegates;                                    // 0x00A8(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnLoadTitleFileComplete__Delegate;                      // 0x00B8(0x0010) (NeedCtorLink)
...
// 0x0074 (0x00F4 - 0x0080)
class UMcpMessageBase : public UMcpServiceBase
{
public:
	struct FString                                     McpMessageManagerClassName;                               // 0x0080(0x0010) (Config, NeedCtorLink)
	TEnumAsByte<EMcpMessageCompressionType>            CompressionType;                                          // 0x0090(0x0001) (Config)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0091(0x0003) MISSED OFFSET
	TArray<struct FMcpMessageContents>                 MessageContentsList;                                      // 0x0094(0x0010) (NeedCtorLink)
	TArray<struct FMcpMessageList>                     MessageLists;                                             // 0x00A4(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnCreateMessageComplete__Delegate;                      // 0x00B4(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnDeleteMessageComplete__Delegate;                      // 0x00C4(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQueryMessagesComplete__Delegate;                      // 0x00D4(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQueryMessageContentsComplete__Delegate;               // 0x00E4(0x0010) (NeedCtorLink)
...
{
public:
	struct FPointer                                    VfTable_FTickableObject;                                  // 0x00F4(0x0008) (Const, Native, NoExport)
	struct FString                                     CreateMessageUrl;                                         // 0x00FC(0x0010) (Config, NeedCtorLink)
	struct FString                                     DeleteMessageUrl;                                         // 0x010C(0x0010) (Config, NeedCtorLink)
	struct FString                                     QueryMessagesUrl;                                         // 0x011C(0x0010) (Config, NeedCtorLink)
	struct FString                                     QueryMessageContentsUrl;                                  // 0x012C(0x0010) (Config, NeedCtorLink)
	struct FString                                     DeleteAllMessagesUrl;                                     // 0x013C(0x0010) (Config, NeedCtorLink)
	TArray<struct FMcpCompressMessageRequest>          CompressMessageRequests;                                  // 0x014C(0x0010) (Native)
	TArray<struct FMcpUncompressMessageRequest>        UncompressMessageRequests;                                // 0x015C(0x0010) (Native)
...
{
public:
	struct FString                                     EnumerateCloudFilesUrl;                                   // 0x0080(0x0010) (Config, NeedCtorLink)
	struct FString                                     ReadCloudFileUrl;                                         // 0x0090(0x0010) (Config, NeedCtorLink)
	struct FString                                     WriteCloudFileUrl;                                        // 0x00A0(0x0010) (Config, NeedCtorLink)
	struct FString                                     DeleteCloudFileUrl;                                       // 0x00B0(0x0010) (Config, NeedCtorLink)
	TArray<struct FMcpUserCloudFilesEntry>             UserCloudFileRequests;                                    // 0x00C0(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     EnumerateUserFilesCompleteDelegates;                      // 0x00D0(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     ReadUserFileCompleteDelegates;                            // 0x00E0(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     WriteUserFileCompleteDelegates;                           // 0x00F0(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     DeleteUserFileCompleteDelegates;                          // 0x0100(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnEnumerateUserFilesComplete__Delegate;                 // 0x0110(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnReadUserFileComplete__Delegate;                       // 0x0120(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnWriteUserFileComplete__Delegate;                      // 0x0130(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnDeleteUserFileComplete__Delegate;                     // 0x0140(0x0010) (NeedCtorLink)
...
public:
	...
	int                                                MeshBeaconPort;                                           // 0x0070(0x0004) (Config)
	struct FPointer                                    Socket;                                                   // 0x0074(0x0008) (Native, Transient)
	unsigned long                                      bIsInTick : 1;                                            // 0x007C(0x0004) (Transient)
	unsigned long                                      bWantsDeferredDestroy : 1;                                // 0x007C(0x0004) (Transient)
	unsigned long                                      bShouldTick : 1;                                          // 0x007C(0x0004)
	float                                              HeartbeatTimeout;                                         // 0x0080(0x0004) (Config)
	float                                              ElapsedHeartbeatTime;                                     // 0x0084(0x0004)
	struct FName                                       BeaconName;                                               // 0x0088(0x0008)
	int                                                SocketSendBufferSize;                                     // 0x0090(0x0004) (Config)
	int                                                SocketReceiveBufferSize;                                  // 0x0094(0x0004) (Config)
	int                                                MaxBandwidthTestBufferSize;                               // 0x0098(0x0004) (Config)
	int                                                MinBandwidthTestBufferSize;                               // 0x009C(0x0004) (Config)
	float                                              MaxBandwidthTestSendTime;                                 // 0x00A0(0x0004) (Config)
	float                                              MaxBandwidthTestReceiveTime;                              // 0x00A4(0x0004) (Config)
	int                                                MaxBandwidthHistoryEntries;                               // 0x00A8(0x0004) (Config)
...
{
public:
	struct FOnlineGameSearchResult                     HostPendingRequest;                                       // 0x00AC(0x0010) (Const)
	struct FClientConnectionRequest                    ClientPendingRequest;                                     // 0x00BC(0x0030) (Const, NeedCtorLink)
	struct FClientBandwidthTestData                    CurrentBandwidthTest;                                     // 0x00EC(0x0014)
	TEnumAsByte<EMeshBeaconClientState>                ClientBeaconState;                                        // 0x0100(0x0001)
	TEnumAsByte<EMeshBeaconPacketType>                 ClientBeaconRequestType;                                  // 0x0101(0x0001)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0102(0x0002) MISSED OFFSET
	float                                              ConnectionRequestTimeout;                                 // 0x0104(0x0004) (Config)
	float                                              ConnectionRequestElapsedTime;                             // 0x0108(0x0004)
	struct FString                                     ResolverClassName;                                        // 0x010C(0x0010) (Config, NeedCtorLink)
	class UClass*                                      ResolverClass;                                            // 0x011C(0x0008)
	class UClientBeaconAddressResolver*                Resolver;                                                 // 0x0124(0x0008)
	unsigned long                                      bUsingRegisteredAddr : 1;                                 // 0x012C(0x0004) (Transient)
	struct FScriptDelegate                             __OnConnectionRequestResult__Delegate;                    // 0x0130(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnReceivedBandwidthTestRequest__Delegate;               // 0x0140(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnReceivedBandwidthTestResults__Delegate;               // 0x0150(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnTravelRequestReceived__Delegate;                      // 0x0160(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnCreateNewSessionRequestReceived__Delegate;            // 0x0170(0x0010) (NeedCtorLink)
...
{
public:
	TArray<struct FClientMeshBeaconConnection>         ClientConnections;                                        // 0x00AC(0x0010) (Const, NeedCtorLink)
	TArray<struct FUniqueNetId>                        PendingPlayerConnections;                                 // 0x00BC(0x0010) (NeedCtorLink)
	struct FUniqueNetId                                OwningPlayerId;                                           // 0x00CC(0x0010) (Const)
	unsigned long                                      bAllowBandwidthTesting : 1;                               // 0x00DC(0x0004)
	int                                                ConnectionBacklog;                                        // 0x00E0(0x0004) (Config)
	struct FScriptDelegate                             __OnReceivedClientConnectionRequest__Delegate;            // 0x00E4(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnStartedBandwidthTest__Delegate;                       // 0x00F4(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnFinishedBandwidthTest__Delegate;                      // 0x0104(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnAllPendingPlayersConnected__Delegate;                 // 0x0114(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnReceivedClientCreateNewSessionResult__Delegate;       // 0x0124(0x0010) (NeedCtorLink)
...
// 0x0024 (0x0218 - 0x01F4)
class UOnlineSubsystemCommonImpl : public UOnlineSubsystem
{
public:
	struct FPointer                                    VoiceEngine;                                              // 0x01F4(0x0008) (Const, Native, Transient)
	int                                                MaxLocalTalkers;                                          // 0x01FC(0x0004) (Config)
	int                                                MaxRemoteTalkers;                                         // 0x0200(0x0004) (Config)
	unsigned long                                      bIsUsingSpeechRecognition : 1;                            // 0x0204(0x0004) (Config)
	class UOnlineGameInterfaceImpl*                    GameInterfaceImpl;                                        // 0x0208(0x0008)
	class UOnlineAuthInterfaceImpl*                    AuthInterfaceImpl;                                        // 0x0210(0x0008)
...
// 0x02C4 (0x032C - 0x0068)
class UOnlineAuthInterfaceImpl : public UObject
{
public:
	struct FPointer                                    VfTable_IOnlineAuthInterface;                             // 0x0068(0x0008) (Const, Native, NoExport)
	class UOnlineSubsystemCommonImpl*                  OwningSubsystem;                                          // 0x0070(0x0008)
	unsigned long                                      bAuthReady : 1;                                           // 0x0078(0x0004) (Const)
	struct FSparseArray_Mirror                         ClientAuthSessions;                                       // 0x007C(0x0038) (Const, Native)
	struct FSparseArray_Mirror                         ServerAuthSessions;                                       // 0x00B4(0x0038) (Const, Native)
	struct FSparseArray_Mirror                         PeerAuthSessions;                                         // 0x00EC(0x0038) (Const, Native)
	struct FSparseArray_Mirror                         LocalClientAuthSessions;                                  // 0x0124(0x0038) (Const, Native)
	struct FSparseArray_Mirror                         LocalServerAuthSessions;                                  // 0x015C(0x0038) (Const, Native)
	struct FSparseArray_Mirror                         LocalPeerAuthSessions;                                    // 0x0194(0x0038) (Const, Native)
	TArray<struct FScriptDelegate>                     AuthReadyDelegates;                                       // 0x01CC(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     ClientAuthRequestDelegates;                               // 0x01DC(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     ServerAuthRequestDelegates;                               // 0x01EC(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     ClientAuthResponseDelegates;                              // 0x01FC(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     ServerAuthResponseDelegates;                              // 0x020C(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     ClientAuthCompleteDelegates;                              // 0x021C(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     ServerAuthCompleteDelegates;                              // 0x022C(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     ClientAuthEndSessionRequestDelegates;                     // 0x023C(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     ServerAuthRetryRequestDelegates;                          // 0x024C(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     ClientConnectionCloseDelegates;                           // 0x025C(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     ServerConnectionCloseDelegates;                           // 0x026C(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnAuthReady__Delegate;                                  // 0x027C(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnClientAuthRequest__Delegate;                          // 0x028C(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnServerAuthRequest__Delegate;                          // 0x029C(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnClientAuthResponse__Delegate;                         // 0x02AC(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnServerAuthResponse__Delegate;                         // 0x02BC(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnClientAuthComplete__Delegate;                         // 0x02CC(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnServerAuthComplete__Delegate;                         // 0x02DC(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnClientAuthEndSessionRequest__Delegate;                // 0x02EC(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnServerAuthRetryRequest__Delegate;                     // 0x02FC(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnClientConnectionClose__Delegate;                      // 0x030C(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnServerConnectionClose__Delegate;                      // 0x031C(0x0010) (NeedCtorLink)
...
public:
	...
	class UOnlineGameSettings*                         GameSettings;                                             // 0x0070(0x0008) (Const)
	class UOnlineGameSearch*                           GameSearch;                                               // 0x0078(0x0008) (Const)
	TArray<struct FScriptDelegate>                     CreateOnlineGameCompleteDelegates;                        // 0x0080(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     UpdateOnlineGameCompleteDelegates;                        // 0x0090(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     DestroyOnlineGameCompleteDelegates;                       // 0x00A0(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     JoinOnlineGameCompleteDelegates;                          // 0x00B0(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     MigrateOnlineGameCompleteDelegates;                       // 0x00C0(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     JoinMigratedOnlineGameCompleteDelegates;                  // 0x00D0(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     RecalculateSkillRatingCompleteDelegates;                  // 0x00E0(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     StartOnlineGameCompleteDelegates;                         // 0x00F0(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     EndOnlineGameCompleteDelegates;                           // 0x0100(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     FindOnlineGamesCompleteDelegates;                         // 0x0110(0x0010) (NeedCtorLink)
	TArray<struct FScriptDelegate>                     CancelFindOnlineGamesCompleteDelegates;                   // 0x0120(0x0010) (NeedCtorLink)
	TEnumAsByte<ELanBeaconState>                       LanBeaconState;                                           // 0x0130(0x0001) (Const)
	unsigned char                                      LanNonce[0x8];                                            // 0x0131(0x0001) (Const)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0139(0x0003) MISSED OFFSET
	int                                                LanAnnouncePort;                                          // 0x013C(0x0004) (Const, Config)
	int                                                LanGameUniqueId;                                          // 0x0140(0x0004) (Const, Config)
	int                                                LanPacketPlatformMask;                                    // 0x0144(0x0004) (Const, Config)
	float                                              LanQueryTimeLeft;                                         // 0x0148(0x0004)
	float                                              LanQueryTimeout;                                          // 0x014C(0x0004) (Config)
	struct FPointer                                    LanBeacon;                                                // 0x0150(0x0008) (Const, Native, Transient)
	struct FPointer                                    SessionInfo;                                              // 0x0158(0x0008) (Const, Native, Transient)
	struct FScriptDelegate                             __OnFindOnlineGamesComplete__Delegate;                    // 0x0160(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnCreateOnlineGameComplete__Delegate;                   // 0x0170(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnUpdateOnlineGameComplete__Delegate;                   // 0x0180(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnDestroyOnlineGameComplete__Delegate;                  // 0x0190(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnCancelFindOnlineGamesComplete__Delegate;              // 0x01A0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnJoinOnlineGameComplete__Delegate;                     // 0x01B0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnCreateOnlineGameWithPartyComplete__Delegate;          // 0x01C0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnMatchmakeOnlineGameWithPartyComplete__Delegate;       // 0x01D0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnCreateOnlineSessionComplete__Delegate;                // 0x01E0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnAddSessionMemberComplete__Delegate;                   // 0x01F0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnRegisterGameSessionComplete__Delegate;                // 0x0200(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQueryMatchmakingForSessionComplete__Delegate;         // 0x0210(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnDeleteMatchTicketComplete__Delegate;                  // 0x0220(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnUpdateSessionPropertiesComplete__Delegate;            // 0x0230(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnGameSessionReady__Delegate;                           // 0x0240(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnAcceptPendingGameSessionComplete__Delegate;           // 0x0250(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnGamePlayersChanged__Delegate;                         // 0x0260(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnMatchStatusChanged__Delegate;                         // 0x0270(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnLeaveOnlineSessionComplete__Delegate;                 // 0x0280(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQuerySessionsForUserComplete__Delegate;               // 0x0290(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnJoinOnlineSessionComplete__Delegate;                  // 0x02A0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnRegisterPlayerComplete__Delegate;                     // 0x02B0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnUnregisterPlayerComplete__Delegate;                   // 0x02C0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnStartOnlineGameComplete__Delegate;                    // 0x02D0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnEndOnlineGameComplete__Delegate;                      // 0x02E0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnArbitrationRegistrationComplete__Delegate;            // 0x02F0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnGameInviteAccepted__Delegate;                         // 0x0300(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnRecalculateSkillRatingComplete__Delegate;             // 0x0310(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnMigrateOnlineGameComplete__Delegate;                  // 0x0320(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnJoinMigratedOnlineGameComplete__Delegate;             // 0x0330(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnGetAvailablePlayersFromPartyComplete__Delegate;       // 0x0340(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnPullReservedPlayersIntoSessionComplete__Delegate;     // 0x0350(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnPokeInactivePlayersComplete__Delegate;                // 0x0360(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQosStatusChanged__Delegate;                           // 0x0370(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnGetSessionMemberInfoComplete__Delegate;               // 0x0380(0x0010) (NeedCtorLink)
	...
	bool GetCurrentSessionMemberInfo(unsigned char LocalUserNum, const struct FName& SessionName);
	...
	void OnPokeInactivePlayersComplete(const struct FName& SessionName, bool bWasSuccessful);
	bool PokeInactivePlayers(unsigned char PlayerNum, const struct FName& SessionName);
	...
	void OnPullReservedPlayersIntoSessionComplete(const struct FName& SessionName, bool bWasSuccessful);
	bool PullReservedPlayersIntoSession(unsigned char PlayerNum, const struct FName& SessionName);
	...
	bool GetAvailablePlayersFromParty(unsigned char PlayerNum);
	...
	void OnJoinOnlineSessionComplete(const struct FName& SessionName, bool bWasSuccessful);
	bool JoinOnlineSession(unsigned char LocalPlayerNum, const struct FName& SessionName);
	...
	void OnLeaveOnlineSessionComplete(const struct FName& SessionName, bool bWasSuccessful);
	...
	void OnDeleteMatchTicketComplete(const struct FName& SessionName, bool bWasSuccessful);
	bool DeleteMatchTicketWithHopper(unsigned char ScoutingPlayerNum, const struct FName& SessionName, const struct FString& HopperName);
	bool DeleteMatchTicket(unsigned char ScoutingPlayerNum, const struct FName& SessionName);
	...
	void OnQueryMatchmakingForSessionComplete(const struct FName& SessionName, bool bWasSuccessful);
	bool QueryMatchmakingForSessionWithHopper(unsigned char ScoutingPlayerNum, const struct FName& SessionName, int MatchTimeout, const struct FString& HopperName, TEnumAsByte<EOnlineCreateGameSessionFlag> CreateGameSessionType);
	bool QueryMatchmakingForSession(unsigned char ScoutingPlayerNum, const struct FName& SessionName, int MatchTimeout, TEnumAsByte<EOnlineCreateGameSessionFlag> CreateGameSessionType);
	...
	void OnRegisterGameSessionComplete(const struct FName& SessionName, bool bWasSuccessful);
	bool RegisterGameSession(unsigned char ScoutingPlayerNum, const struct FName& SessionName);
	...
	void OnCreateOnlineSessionComplete(const struct FName& SessionName, bool bWasSuccessful);
	bool CreateOnlineSessionWithTemplate(unsigned char ScoutingPlayerNum, const struct FName& SessionName, class UOnlineGameSettings* NewGameSettings, const struct FString& TemplateName);
	bool CreateOnlineSession(unsigned char ScoutingPlayerNum, const struct FName& SessionName, class UOnlineGameSettings* NewGameSettings);
...
public:
	struct FPointer                                    VfTable_FTickableObject;                                  // 0x0068(0x0008) (Const, Native, NoExport)
	TArray<struct FPlaylist>                           Playlists;                                                // 0x0070(0x0010) (Config, NeedCtorLink)
	TArray<struct FString>                             PlaylistFileNames;                                        // 0x0080(0x0010) (NeedCtorLink)
	TArray<struct FName>                               DatastoresToRefresh;                                      // 0x0090(0x0010) (Config, NeedCtorLink)
	int                                                DownloadCount;                                            // 0x00A0(0x0004)
	int                                                SuccessfulCount;                                          // 0x00A4(0x0004)
	int                                                VersionNumber;                                            // 0x00A8(0x0004) (Config)
	TArray<struct FPlaylistPopulation>                 PopulationData;                                           // 0x00AC(0x0010) (Config, NeedCtorLink)
	int                                                WorldwideTotalPlayers;                                    // 0x00BC(0x0004)
	int                                                RegionTotalPlayers;                                       // 0x00C0(0x0004)
	TScriptInterface<class UOnlineTitleFileInterface>  TitleFileInterface;                                       // 0x00C4(0x0010) (Transient)
	struct FString                                     PopulationFileName;                                       // 0x00D4(0x0010) (NeedCtorLink)
	float                                              NextPlaylistPopulationUpdateTime;                         // 0x00E4(0x0004) (Transient)
	float                                              PlaylistPopulationUpdateInterval;                         // 0x00E8(0x0004) (Config)
	int                                                MinPlaylistIdToReport;                                    // 0x00EC(0x0004) (Config)
	int                                                CurrentPlaylistId;                                        // 0x00F0(0x0004) (Transient)
	struct FName                                       EventsInterfaceName;                                      // 0x00F4(0x0008) (Config)
	int                                                DataCenterId;                                             // 0x00FC(0x0004) (Config)
	...
	struct FScriptDelegate                             __OnPlaylistPopulationDataUpdated__Delegate;              // 0x0128(0x0010) (NeedCtorLink)
...
public:
	struct FPointer                                    VfTable_FTickableObject;                                  // 0x0068(0x0008) (Const, Native, NoExport)
	int                                                PartyBeaconPort;                                          // 0x0070(0x0004) (Config)
	struct FPointer                                    Socket;                                                   // 0x0074(0x0008) (Native, Transient)
	unsigned long                                      bIsInTick : 1;                                            // 0x007C(0x0004)
	unsigned long                                      bWantsDeferredDestroy : 1;                                // 0x007C(0x0004)
	unsigned long                                      bShouldTick : 1;                                          // 0x007C(0x0004)
	float                                              HeartbeatTimeout;                                         // 0x0080(0x0004) (Config)
	float                                              ElapsedHeartbeatTime;                                     // 0x0084(0x0004)
	struct FName                                       BeaconName;                                               // 0x0088(0x0008)
...
{
public:
	struct FOnlineGameSearchResult                     HostPendingRequest;                                       // 0x00A0(0x0010) (Const)
	struct FPartyReservation                           PendingRequest;                                           // 0x00B0(0x0024) (NeedCtorLink)
	TEnumAsByte<EPartyBeaconClientState>               ClientBeaconState;                                        // 0x00D4(0x0001)
	TEnumAsByte<EPartyBeaconClientRequest>             ClientBeaconRequestType;                                  // 0x00D5(0x0001)
	unsigned char                                      UnknownData00[0x2];                                       // 0x00D6(0x0002) MISSED OFFSET
	float                                              ReservationRequestTimeout;                                // 0x00D8(0x0004) (Config)
	float                                              ReservationRequestElapsedTime;                            // 0x00DC(0x0004)
	struct FString                                     ResolverClassName;                                        // 0x00E0(0x0010) (Config, NeedCtorLink)
	class UClass*                                      ResolverClass;                                            // 0x00F0(0x0008)
	class UClientBeaconAddressResolver*                Resolver;                                                 // 0x00F8(0x0008)
	struct FScriptDelegate                             __OnReservationRequestComplete__Delegate;                 // 0x0100(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnReservationCountUpdated__Delegate;                    // 0x0110(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnTravelRequestReceived__Delegate;                      // 0x0120(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnHostIsReady__Delegate;                                // 0x0130(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnHostHasCancelled__Delegate;                           // 0x0140(0x0010) (NeedCtorLink)
...
{
public:
	TArray<struct FClientBeaconConnection>             Clients;                                                  // 0x00A0(0x0010) (Const, NeedCtorLink)
	int                                                NumTeams;                                                 // 0x00B0(0x0004) (Const)
	int                                                NumPlayersPerTeam;                                        // 0x00B4(0x0004) (Const)
	int                                                NumReservations;                                          // 0x00B8(0x0004) (Const)
	int                                                NumConsumedReservations;                                  // 0x00BC(0x0004) (Const)
	TArray<struct FPartyReservation>                   Reservations;                                             // 0x00C0(0x0010) (Const, NeedCtorLink)
	struct FName                                       OnlineSessionName;                                        // 0x00D0(0x0008)
	int                                                ConnectionBacklog;                                        // 0x00D8(0x0004) (Config)
	int                                                ForceTeamNum;                                             // 0x00DC(0x0004) (Const)
	int                                                ReservedHostTeamNum;                                      // 0x00E0(0x0004) (Const)
	unsigned long                                      bBestFitTeamAssignment : 1;                               // 0x00E4(0x0004)
	TEnumAsByte<EPartyBeaconHostState>                 BeaconState;                                              // 0x00E8(0x0001) (Const)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00E9(0x0003) MISSED OFFSET
	struct FScriptDelegate                             __OnReservationChange__Delegate;                          // 0x00EC(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnReservationsFull__Delegate;                           // 0x00FC(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnClientCancellationReceived__Delegate;                 // 0x010C(0x0010) (NeedCtorLink)
...
// 0x0024 (0xB104 - 0xB0E0)
class UTcpipConnection : public UNetConnection
{
public:
	unsigned char                                      UnknownData00[0x24];                                      // 0xB0E0(0x0024) MISSED OFFSET
...
// 0x0020 (0x021C - 0x01FC)
class UTcpNetDriver : public UNetDriver
{
public:
	unsigned long                                      AllowPlayerPortUnreach : 1;                               // 0x01FC(0x0004) (Config)
	unsigned long                                      UnknownData00 : 31;                                       // 0x01FC(0x0001)
	unsigned long                                      LogPortUnreach : 1;                                       // 0x0200(0x0004) (Config)
	unsigned char                                      UnknownData01[0x18];                                      // 0x0204(0x0018) MISSED OFFSET
...
{
public:
	struct FString                                     RemoteAddr;                                               // 0x0068(0x0010) (NeedCtorLink)
	struct FString                                     URI;                                                      // 0x0078(0x0010) (NeedCtorLink)
	struct FString                                     UserName;                                                 // 0x0088(0x0010) (NeedCtorLink)
	struct FString                                     Password;                                                 // 0x0098(0x0010) (NeedCtorLink)
	int                                                ContentLength;                                            // 0x00A8(0x0004)
	struct FString                                     ContentType;                                              // 0x00AC(0x0010) (NeedCtorLink)
	TEnumAsByte<ERequestType>                          RequestType;                                              // 0x00BC(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00BD(0x0003) MISSED OFFSET
	struct FMap_Mirror                                 HeaderMap;                                                // 0x00C0(0x0048) (Const, Native)
	struct FMap_Mirror                                 VariableMap;                                              // 0x0108(0x0048) (Const, Native)
...
{
public:
	TArray<struct FString>                             Headers;                                                  // 0x0068(0x0010) (NeedCtorLink)
	struct FMap_Mirror                                 ReplacementMap;                                           // 0x0078(0x0048) (Const, Native)
...
{
public:
	int                                                PlaylistId;                                               // 0x009C(0x0004) (Config)
	TArray<struct FName>                               PlaylistGameTypeNames;                                    // 0x00A0(0x0010) (Config, NeedCtorLink)
	struct FString                                     DisplayName;                                              // 0x00B0(0x0010) (Const, Config, Localized, NeedCtorLink)
	int                                                Priority;                                                 // 0x00C0(0x0004) (Config)
...
{
public:
	class AWorldInfo*                                  WorldInfo;                                                // 0x0068(0x0008)
	class AWebServer*                                  WebServer;                                                // 0x0070(0x0008)
	struct FString                                     Path;                                                     // 0x0078(0x0010) (NeedCtorLink)
...
// 0x01CC (0x0478 - 0x02AC)
class AWebServer : public ATcpLink
{
public:
	struct FString                                     ServerName;                                               // 0x02AC(0x0010) (Config, NeedCtorLink)
	struct FString                                     Applications[0xA];                                        // 0x02BC(0x0010) (Config, NeedCtorLink)
	struct FString                                     ApplicationPaths[0xA];                                    // 0x035C(0x0010) (Config, NeedCtorLink)
	unsigned long                                      bEnabled : 1;                                             // 0x03FC(0x0004) (Config)
	int                                                ListenPort;                                               // 0x0400(0x0004) (Config)
	int                                                MaxConnections;                                           // 0x0404(0x0004) (Config)
	int                                                DefaultApplication;                                       // 0x0408(0x0004) (Config)
	int                                                ExpirationSeconds;                                        // 0x040C(0x0004) (Config)
	struct FString                                     ServerURL;                                                // 0x0410(0x0010) (NeedCtorLink)
	class UWebApplication*                             ApplicationObjects[0xA];                                  // 0x0420(0x0008)
	int                                                ConnectionCount;                                          // 0x0470(0x0004)
	int                                                ConnID;                                                   // 0x0474(0x0004)
...
{
public:
	struct FString                                     Protocol;                                                 // 0x0068(0x0010) (Config, NeedCtorLink)
	struct FString                                     Domain;                                                   // 0x0078(0x0010) (Config, NeedCtorLink)
	struct FString                                     AppKey;                                                   // 0x0088(0x0010) (NeedCtorLink)
	struct FString                                     AppSecret;                                                // 0x0098(0x0010) (NeedCtorLink)
...
{
public:
	struct FString                                     McpClashMobClassName;                                     // 0x0080(0x0010) (Config, NeedCtorLink)
	struct FScriptDelegate                             __OnQueryChallengeListComplete__Delegate;                 // 0x0090(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnDownloadChallengeFileComplete__Delegate;              // 0x00A0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnAcceptChallengeComplete__Delegate;                    // 0x00B0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQueryChallengeUserStatusComplete__Delegate;           // 0x00C0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnUpdateChallengeUserProgressComplete__Delegate;        // 0x00D0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnUpdateChallengeUserRewardComplete__Delegate;          // 0x00E0(0x0010) (NeedCtorLink)
...
{
public:
	struct FString                                     ChallengeListUrl;                                         // 0x00F0(0x0010) (Config, NeedCtorLink)
	struct FString                                     ChallengeStatusUrl;                                       // 0x0100(0x0010) (Config, NeedCtorLink)
	struct FString                                     ChallengeMultiStatusUrl;                                  // 0x0110(0x0010) (Config, NeedCtorLink)
	struct FString                                     AcceptChallengeUrl;                                       // 0x0120(0x0010) (Config, NeedCtorLink)
	struct FString                                     UpdateChallengeProgressUrl;                               // 0x0130(0x0010) (Config, NeedCtorLink)
	struct FString                                     UpdateRewardProgressUrl;                                  // 0x0140(0x0010) (Config, NeedCtorLink)
	class UHttpRequestInterface*                       HTTPRequestChallengeList;                                 // 0x0150(0x0008)
	TArray<struct FMcpChallengeUserRequest>            ChallengeUserRequests;                                    // 0x0158(0x0010) (NeedCtorLink)
	TArray<struct FMcpClashMobChallengeEvent>          ChallengeEvents;                                          // 0x0168(0x0010) (NeedCtorLink)
	TArray<struct FMcpClashMobChallengeUserStatus>     ChallengeUserStatus;                                      // 0x0178(0x0010) (NeedCtorLink)
	struct FMcpClashMobChallengeUserStatus             TempChallengeUserStatus;                                  // 0x0188(0x0080) (NeedCtorLink)
	TArray<struct FMcpClashMobChallengeUserStatus>     TempChallengeUserStatusArray;                             // 0x0208(0x0010) (NeedCtorLink)
	TScriptInterface<class UOnlineTitleFileCacheInterface> FileCache;                                                // 0x0218(0x0010)
	class UMcpClashMobFileDownload*                    FileDownloader;                                           // 0x0228(0x0008)
...
{
public:
	struct FString                                     McpGroupsManagerClassName;                                // 0x0080(0x0010) (Config, NeedCtorLink)
	TArray<struct FMcpGroupList>                       GroupLists;                                               // 0x0090(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnCreateGroupComplete__Delegate;                        // 0x00A0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnDeleteGroupComplete__Delegate;                        // 0x00B0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQueryGroupsComplete__Delegate;                        // 0x00C0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQueryGroupMembersComplete__Delegate;                  // 0x00D0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnAddGroupMembersComplete__Delegate;                    // 0x00E0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnRemoveGroupMembersComplete__Delegate;                 // 0x00F0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnDeleteAllGroupsComplete__Delegate;                    // 0x0100(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQueryGroupInvitesComplete__Delegate;                  // 0x0110(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnAcceptGroupInviteComplete__Delegate;                  // 0x0120(0x0010) (NeedCtorLink)
...
{
public:
	struct FString                                     CreateGroupUrl;                                           // 0x0130(0x0010) (Config, NeedCtorLink)
	struct FString                                     DeleteGroupUrl;                                           // 0x0140(0x0010) (Config, NeedCtorLink)
	struct FString                                     QueryGroupsUrl;                                           // 0x0150(0x0010) (Config, NeedCtorLink)
	struct FString                                     QueryGroupMembersUrl;                                     // 0x0160(0x0010) (Config, NeedCtorLink)
	struct FString                                     AddGroupMembersUrl;                                       // 0x0170(0x0010) (Config, NeedCtorLink)
	struct FString                                     RemoveGroupMembersUrl;                                    // 0x0180(0x0010) (Config, NeedCtorLink)
	struct FString                                     DeleteAllGroupsUrl;                                       // 0x0190(0x0010) (Config, NeedCtorLink)
	struct FString                                     AcceptGroupInviteUrl;                                     // 0x01A0(0x0010) (Config, NeedCtorLink)
	struct FString                                     RejectGroupInviteUrl;                                     // 0x01B0(0x0010) (Config, NeedCtorLink)
	struct FScriptDelegate                             __OnQueryGroupsRequestComplete__Delegate;                 // 0x01C0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQueryGroupMembersRequestComplete__Delegate;           // 0x01D0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnAddGroupMembersRequestComplete__Delegate;             // 0x01E0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnAcceptGroupInviteRequestComplete__Delegate;           // 0x01F0(0x0010) (NeedCtorLink)
...
{
public:
	struct FString                                     McpIdMappingClassName;                                    // 0x0080(0x0010) (Config, NeedCtorLink)
	struct FScriptDelegate                             __OnAddMappingComplete__Delegate;                         // 0x0090(0x0010) (NeedCtorLink)
...
{
public:
	TArray<struct FMcpIdMapping>                       AccountMappings;                                          // 0x00B0(0x0010) (NeedCtorLink)
	struct FString                                     AddMappingUrl;                                            // 0x00C0(0x0010) (Config, NeedCtorLink)
	struct FString                                     QueryMappingUrl;                                          // 0x00D0(0x0010) (Config, NeedCtorLink)
	TArray<struct FAddMappingRequest>                  AddMappingRequests;                                       // 0x00E0(0x0010) (NeedCtorLink)
	TArray<struct FQueryMappingRequest>                QueryMappingRequests;                                     // 0x00F0(0x0010) (NeedCtorLink)
...
{
public:
	struct FString                                     McpManagedValueManagerClassName;                          // 0x0080(0x0010) (Config, NeedCtorLink)
	struct FScriptDelegate                             __OnCreateSaveSlotComplete__Delegate;                     // 0x0090(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnReadSaveSlotComplete__Delegate;                       // 0x00A0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnUpdateValueComplete__Delegate;                        // 0x00B0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnDeleteValueComplete__Delegate;                        // 0x00C0(0x0010) (NeedCtorLink)
...
{
public:
	struct FString                                     CreateSaveSlotUrl;                                        // 0x00D0(0x0010) (Config, NeedCtorLink)
	struct FString                                     ReadSaveSlotUrl;                                          // 0x00E0(0x0010) (Config, NeedCtorLink)
	struct FString                                     UpdateValueUrl;                                           // 0x00F0(0x0010) (Config, NeedCtorLink)
	struct FString                                     DeleteValueUrl;                                           // 0x0100(0x0010) (Config, NeedCtorLink)
	TArray<struct FManagedValueSaveSlot>               SaveSlots;                                                // 0x0110(0x0010) (NeedCtorLink)
	TArray<struct UMcpManagedValueManager_FSaveSlotRequestState> CreateSaveSlotRequests;                                   // 0x0120(0x0010) (NeedCtorLink)
	TArray<struct UMcpManagedValueManager_FSaveSlotRequestState> ReadSaveSlotRequests;                                     // 0x0130(0x0010) (NeedCtorLink)
	TArray<struct FValueRequestState>                  UpdateValueRequests;                                      // 0x0140(0x0010) (NeedCtorLink)
	TArray<struct FValueRequestState>                  DeleteValueRequests;                                      // 0x0150(0x0010) (NeedCtorLink)
...
{
public:
	struct FString                                     McpServerTimeClassName;                                   // 0x0080(0x0010) (Config, NeedCtorLink)
	struct FScriptDelegate                             __OnQueryServerTimeComplete__Delegate;                    // 0x0090(0x0010) (NeedCtorLink)
...
{
public:
	struct FString                                     McpUserInventoryClassName;                                // 0x0080(0x0010) (Config, NeedCtorLink)
	struct FScriptDelegate                             __OnCreateSaveSlotComplete__Delegate;                     // 0x0090(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnDeleteSaveSlotComplete__Delegate;                     // 0x00A0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQuerySaveSlotListComplete__Delegate;                  // 0x00B0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQueryInventoryItemsComplete__Delegate;                // 0x00C0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnPurchaseItemComplete__Delegate;                       // 0x00D0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnSellItemComplete__Delegate;                           // 0x00E0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnEarnItemComplete__Delegate;                           // 0x00F0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnConsumeItemComplete__Delegate;                        // 0x0100(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnDeleteItemComplete__Delegate;                         // 0x0110(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnRecordIapComplete__Delegate;                          // 0x0120(0x0010) (NeedCtorLink)
...
{
public:
	struct FString                                     CreateSaveSlotUrl;                                        // 0x0130(0x0010) (Config, NeedCtorLink)
	struct FString                                     DeleteSaveSlotUrl;                                        // 0x0140(0x0010) (Config, NeedCtorLink)
	struct FString                                     ListSaveSlotUrl;                                          // 0x0150(0x0010) (Config, NeedCtorLink)
	struct FString                                     ListItemsUrl;                                             // 0x0160(0x0010) (Config, NeedCtorLink)
	struct FString                                     PurchaseItemUrl;                                          // 0x0170(0x0010) (Config, NeedCtorLink)
	struct FString                                     SellItemUrl;                                              // 0x0180(0x0010) (Config, NeedCtorLink)
	struct FString                                     EarnItemUrl;                                              // 0x0190(0x0010) (Config, NeedCtorLink)
	struct FString                                     ConsumeItemUrl;                                           // 0x01A0(0x0010) (Config, NeedCtorLink)
	struct FString                                     DeleteItemUrl;                                            // 0x01B0(0x0010) (Config, NeedCtorLink)
	struct FString                                     IapRecordUrl;                                             // 0x01C0(0x0010) (Config, NeedCtorLink)
	TArray<struct FMcpInventorySaveSlot>               SaveSlots;                                                // 0x01D0(0x0010) (NeedCtorLink)
	TArray<struct UMcpUserInventoryManager_FSaveSlotRequestState> SaveSlotRequests;                                         // 0x01E0(0x0010) (NeedCtorLink)
	TArray<struct UMcpUserInventoryManager_FSaveSlotRequestState> ListSaveSlotRequests;                                     // 0x01F0(0x0010) (NeedCtorLink)
	TArray<struct UMcpUserInventoryManager_FSaveSlotRequestState> ListItemsRequests;                                        // 0x0200(0x0010) (NeedCtorLink)
	TArray<struct FInventoryItemRequestState>          ItemRequests;                                             // 0x0210(0x0010) (NeedCtorLink)
...
{
public:
	struct FString                                     McpUserManagerClassName;                                  // 0x0080(0x0010) (Config, NeedCtorLink)
	struct FScriptDelegate                             __OnRegisterUserComplete__Delegate;                       // 0x0090(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnAuthenticateUserComplete__Delegate;                   // 0x00A0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnQueryUsersComplete__Delegate;                         // 0x00B0(0x0010) (NeedCtorLink)
	struct FScriptDelegate                             __OnDeleteUserComplete__Delegate;                         // 0x00C0(0x0010) (NeedCtorLink)
...
{
public:
	TArray<struct FMcpUserStatus>                      UserStatuses;                                             // 0x00D0(0x0010) (NeedCtorLink)
	struct FString                                     RegisterUserMcpUrl;                                       // 0x00E0(0x0010) (Config, NeedCtorLink)
	struct FString                                     RegisterUserFacebookUrl;                                  // 0x00F0(0x0010) (Config, NeedCtorLink)
	struct FString                                     QueryUserUrl;                                             // 0x0100(0x0010) (Config, NeedCtorLink)
	struct FString                                     QueryUsersUrl;                                            // 0x0110(0x0010) (Config, NeedCtorLink)
	struct FString                                     DeleteUserUrl;                                            // 0x0120(0x0010) (Config, NeedCtorLink)
	struct FString                                     FacebookAuthUrl;                                          // 0x0130(0x0010) (Config, NeedCtorLink)
	struct FString                                     McpAuthUrl;                                               // 0x0140(0x0010) (Config, NeedCtorLink)
	TArray<class UHttpRequestInterface*>               RegisterUserRequests;                                     // 0x0150(0x0010) (NeedCtorLink)
	TArray<class UHttpRequestInterface*>               QueryUsersRequests;                                       // 0x0160(0x0010) (NeedCtorLink)
	TArray<struct FUserRequest>                        DeleteUserRequests;                                       // 0x0170(0x0010) (NeedCtorLink)
	TArray<class UHttpRequestInterface*>               AuthUserRequests;                                         // 0x0180(0x0010) (NeedCtorLink)
...
{
public:
	TArray<struct FOnlineImageDownload>                DownloadImages;                                           // 0x0068(0x0010) (NeedCtorLink)
	int                                                MaxSimultaneousDownloads;                                 // 0x0078(0x0004) (Config)
	struct FScriptDelegate                             __OnOnlineImageDownloaded__Delegate;                      // 0x007C(0x0010) (NeedCtorLink)
...
{
public:
	class AWebServer*                                  WebServer;                                                // 0x02AC(0x0008)
	struct FString                                     ReceivedData;                                             // 0x02B4(0x0010) (NeedCtorLink)
	class UWebRequest*                                 Request;                                                  // 0x02C4(0x0008)
	class UWebResponse*                                Response;                                                 // 0x02CC(0x0008)
	class UWebApplication*                             Application;                                              // 0x02D4(0x0008)
	unsigned long                                      bDelayCleanup : 1;                                        // 0x02DC(0x0004)
	int                                                RawBytesExpecting;                                        // 0x02E0(0x0004)
	int                                                MaxValueLength;                                           // 0x02E4(0x0004) (Config)
	int                                                MaxLineLength;                                            // 0x02E8(0x0004) (Config)
	int                                                ConnID;                                                   // 0x02EC(0x0004)
