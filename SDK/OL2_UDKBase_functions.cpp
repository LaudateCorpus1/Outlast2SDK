...
bool UUDKOnlineEventTracker::RaiseEvent(const struct FString& EventName, TArray<struct FString> EventParams)
{
	static auto fn = UObject::FindObject<UFunction>("Function UDKBase.UDKOnlineEventTracker.RaiseEvent");

	UUDKOnlineEventTracker_RaiseEvent_Params params;
...
void UUDKOnlineEventTracker::ShutDown()
{
	static auto fn = UObject::FindObject<UFunction>("Function UDKBase.UDKOnlineEventTracker.ShutDown");

	UUDKOnlineEventTracker_ShutDown_Params params;
...
void UUDKOnlineEventTracker::Init()
{
	static auto fn = UObject::FindObject<UFunction>("Function UDKBase.UDKOnlineEventTracker.Init");

	UUDKOnlineEventTracker_Init_Params params;
...
void AMobileProjectile::Landed(const struct FVector& HitLocation, const struct FVector& HitNormal, class AActor* FloorActor)
{
